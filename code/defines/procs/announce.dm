...
/proc/level_eight_announcement() //new announcment so the crew doesn't have to fuck around trying to figure out if its a blob, hivemind, or a literal fungus
	command_announcement.Announce("Confirmed outbreak of level 8 Bio-mechanical infestation within the [station_name()]. All personnel must contain the outbreak.", "Biohazard Alert", new_sound = 'sound/AI/outbreak8.ogg')
