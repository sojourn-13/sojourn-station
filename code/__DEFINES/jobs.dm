...
#define JOBS_OVERALL list(JOBS_COMMAND, JOBS_ENGINEERING, JOBS_MEDICAL, JOBS_SCIENCEm JOBS_SECURITY, JOBS_BLACKSHIELD, JOBS_LSS, JOBS_CIVILIAN, JOBS_CHURCH,JOBS_PROSPECTOR)
