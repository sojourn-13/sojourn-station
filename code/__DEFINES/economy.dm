...
#define WAGE_LABOUR_DUMB	150 //Dumb jobs anyone can do. Janitor, actor, cargotech, etc
#define WAGE_LABOUR			200 //The standard wage that most people get
#define WAGE_LABOUR_HAZARD	250	//Hazard pay. For miners and IHOperatives
#define WAGE_PROFESSIONAL	300	//The wage for educated professionals. Doctors, scientists, etc
#define WAGE_COMMAND		400	//Wage paid to command staff, generally regardless of department
