...
#define BIOMASS_TYPES list(/obj/item/reagent_containers/snacks/meat = 50 ,/obj/item/reagent_containers/snacks/meat/roachmeat= 40 ,/obj/item/reagent_containers/snacks/meat/xenomeat = 20)
