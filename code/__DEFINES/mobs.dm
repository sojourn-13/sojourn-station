...
#define WOUND_BLEED_MULTIPLIER 0.015 //Bleeding wounds drip damage*this units of blood per process tick, this also cheats by doble taking, so higher numbers byond 0.1 are insanely bleedy
#define OPEN_ORGAN_BLEED_AMOUNT 0.25 //Wounds with open, unclamped incisions bleed this many units of blood per process tick
