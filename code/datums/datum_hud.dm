...
/datum/hud/human
	...
	HUDneed = list(
//status
	"nutrition"          = list("type" = /obj/screen/nutrition,         "loc" = "EAST+1,BOTTOM+3:16",     "minloc" = "RIGHT,5:16",   "background" = "back17"),
	"nsa"                = list("type" = /obj/screen/nsa,               "loc" = "EAST+1,BOTTOM+4",        "minloc" = "RIGHT,6",      "background" = "back17"),
	"bodytemp"           = list("type" = /obj/screen/bodytemp,          "loc" = "EAST+1,BOTTOM+4:16",     "minloc" = "RIGHT,6:16",   "background" = "back17"),
	"health"             = list("type" = /obj/screen/health,            "loc" = "EAST+1,BOTTOM+5",        "minloc" = "RIGHT,7",      "background" = "back1"),
	"sanity"             = list("type" = /obj/screen/sanity,            "loc" = "EAST+1,BOTTOM+6",        "minloc" = "RIGHT,8",      "background" = "back1"),
	"oxygen"             = list("type" = /obj/screen/oxygen,            "loc" = "EAST+1,BOTTOM+7",        "minloc" = "RIGHT,9",      "background" = "back18"),
	"fire"               = list("type" = /obj/screen/fire,              "loc" = "EAST+1:16,BOTTOM+7",     "minloc" = "RIGHT:16,9",   "background" = "back18"),
	"pressure"           = list("type" = /obj/screen/pressure,          "loc" = "EAST+1,BOTTOM+7:16",     "minloc" = "RIGHT,9:16",   "background" = "back18"),
	"toxin"              = list("type" = /obj/screen/toxin,             "loc" = "EAST+1:16,BOTTOM+7:16",  "minloc" = "RIGHT:16,9:16","background" = "back18"),
	"internal"           = list("type" = /obj/screen/internal,          "loc" = "EAST+1,BOTTOM+8",        "minloc" = "RIGHT,10",     "background" = "back17"),
//corner buttons
	"jump"               = list("type" = /obj/screen/jump,              "loc" = "EAST+1,BOTTOM+1",        "minloc" = "RIGHT,3",      "background" = "back17"),
	"look up"            = list("type" = /obj/screen/look_up,           "loc" = "EAST,BOTTOM:16",         "minloc" = "RIGHT-1,2:16", "background" = "back17-1"),
	"throw"              = list("type" = /obj/screen/HUDthrow,          "loc" = "EAST+1,BOTTOM:16",       "minloc" = "RIGHT,2:16",   "background" = "back17"),
	"pull"               = list("type" = /obj/screen/pull,              "loc" = "EAST-1,BOTTOM:16",       "minloc" = "RIGHT-2,2:16", "background" = "back17"),
	"drop"               = list("type" = /obj/screen/drop,              "loc" = "EAST+1,BOTTOM",          "minloc" = "RIGHT,2",      "background" = "back17"),
	"resist"             = list("type" = /obj/screen/resist,            "loc" = "EAST-1,BOTTOM",          "minloc" = "RIGHT-2,2",    "background" = "back17"),
	"rest"               = list("type" = /obj/screen/rest,              "loc" = "EAST,BOTTOM",            "minloc" = "RIGHT-1,2",    "background" = "back17"),
	...
	"intent"             = list("type" = /obj/screen/intent,            "loc" = "EAST-1,BOTTOM-1",        "minloc" = "13,1"),
...
//hand buttons
	...
	HUDfrippery = list(
		...
		list("loc" = "EAST+1,BOTTOM+2:16", "icon_state" = "frame1-1"),
		list("loc" = "EAST+1,BOTTOM+2:16", "icon_state" = "frame3-3"),
		list("loc" = "EAST+1,BOTTOM+2:16", "icon_state" = "frame0-4"),
		list("loc" = "EAST+1,BOTTOM+8:16", "icon_state" = "frame0-1"),
		list("loc" = "EAST+1,BOTTOM+8:16", "icon_state" = "frame3-1")
		)
