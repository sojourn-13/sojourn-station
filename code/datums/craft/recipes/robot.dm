...
/datum/craft_recipe/robotic/hydrogen_knight
	...
	steps = list(
		...
		list(/obj/item/bot_part/head_frame, 1, "time" = 30),
		list(/obj/item/bot_part/left_arm_frame, 1, "time" = 30),
		list(/obj/item/bot_part/right_arm_frame, 1, "time" = 30),
		list(/obj/item/bot_part/left_leg_frame, 1, "time" = 30),
		list(/obj/item/bot_part/right_leg_frame, 1, "time" = 30),
		list(/obj/item/clothing/shoes/magboots, 1, "time" = 30),
		list(CRAFT_MATERIAL, 6, MATERIAL_OSMIUM, "time" = 30),
