...
/datum/recipe
	...
	var/result        // example: = /obj/item/reagent_containers/snacks/donut/normal
...
/datum/recipe/proc/check_fruit(var/obj/container)
	...
	if(fruit && fruit.len)
		...
		for(var/obj/item/reagent_containers/snacks/grown/G in container)
...
/datum/recipe/proc/check_items(var/obj/container as obj)
	...
	if (items && items.len)
		...
		for(var/obj/O in container)
			if(istype(O,/obj/item/reagent_containers/snacks/grown))
