...
/datum/category_item/setup_option/background/ethnicity/slime_scientist
	...
	stat_modifiers = list(
		...
		STAT_BIO = 0,
		STAT_MEC = 0,
		STAT_COG = 16 //we get a little more of our special stat because it's fairly weak.
	)

/datum/category_item/setup_option/background/ethnicity/slime_corpsman
	name = "Aral (Magenta)"
	desc = "With a particularly thick dermis and a gentle effect, the Aral are hypothesized to have fit something of an equivalent \
