...
/datum/category_item/setup_option/background/homeworld/krios
	...
	desc = "Thought by some to be less a literal time, place and culture. The Aulvae often speak in flowery prose of the past from which they come. Contradictory \
	stories and vaguery have left many to wonder if it is not simply a collective coping mechanism as the Aulvae can recall precious little else from their past. \
