...
/decl/hierarchy/outfit/job/outsider
	...
	l_ear = null
	id_type = null
	backpack_contents = list(/obj/item/weapon/storage/firstaid/regular = 1, /obj/item/weapon/reagent_containers/hypospray/autoinjector/spaceacillin = 1, /obj/item/weapon/tool/knife/shiv = 1)