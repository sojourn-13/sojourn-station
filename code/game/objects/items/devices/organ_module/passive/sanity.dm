...
/obj/item/organ_module/sanity_on_a_buget
	...
	desc = "A small set of braces, tubes and some wiring to help the user calm down much faster after stressful stimulations at the cost of dulling insight."
...
/obj/item/organ_module/sanity_on_a_buget/onInstall(obj/item/organ/external/E)
	if(ishuman(E.owner))
		...
		H.sanity.insight_rest_gain_multiplier /= 5
