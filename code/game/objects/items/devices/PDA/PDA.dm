...
/obj/item/device/pda
	...
	desc = "A portable microcomputer by NanoTrason, due to many people finding it hard to repair and replace, it was phased out in favor of the more modular models made by Soteria. \
