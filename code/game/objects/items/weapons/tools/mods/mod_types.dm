...
/obj/item/tool_upgrade/reinforcement/stick/New()
	...
	I.required_qualities = list(QUALITY_BOLT_TURNING, QUALITY_PRYING, QUALITY_SAWING, QUALITY_SHOVELING, QUALITY_DIGGING, QUALITY_EXCAVATION, QUALITY_HAMMERING, QUALITY_CUTTING)
	I.prefix = "braced"
...
/obj/item/tool_upgrade/productivity/booster/New()
	...
	I.weapon_upgrades = list(
	GUN_UPGRADE_PVE_PROJ_MULT_DAMAGE = 1.25,
