...
/obj/item/weapon/storage/firstaid/soteria/large
	...
	desc = "A reinforced, specialized triage kit outfitted for Soteria personnel only. This one is larger in capacity thanks to a Guild design, and should help Paramedics carry everything they need for any emergency."
	icon_state = "rtk"
	item_state = "rtk"
	storage_slots = 12
	max_w_class = ITEM_SIZE_NORMAL
