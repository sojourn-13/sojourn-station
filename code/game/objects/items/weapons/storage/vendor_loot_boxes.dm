/obj/item/weapon/storage/box/vendor_lootbox
...
/obj/item/weapon/storage/box/vendor_lootbox/populate_contents()
...
/obj/item/weapon/storage/box/vendor_lootbox/combat_basic_light
...
/obj/item/weapon/storage/box/vendor_lootbox/combat_basic_light/populate_contents()
	if(prob(10)) //Medical man!
		...
		new /obj/item/weapon/reagent_containers/food/snacks/candy_drop_red(src)
...
/obj/item/weapon/storage/box/vendor_lootbox/combat_basic_medium
...
/obj/item/weapon/storage/box/vendor_lootbox/combat_basic_medium/populate_contents()
	if(prob(10))
		new /obj/item/stack/medical/advanced/bruise_pack(src)
		new /obj/item/stack/medical/advanced/bruise_pack(src)
		new /obj/item/stack/medical/advanced/ointment(src)
...
/obj/item/weapon/storage/box/vendor_lootbox/combat_basic_high
...
/obj/item/weapon/storage/box/vendor_lootbox/combat_basic_high/populate_contents()
	if(prob(10))
		new /obj/item/stack/medical/advanced/bruise_pack(src)
		new /obj/item/stack/medical/advanced/bruise_pack(src)
		new /obj/item/stack/medical/advanced/ointment(src)
...
/obj/item/weapon/storage/box/vendor_lootbox/medicine_basic
...
/obj/item/weapon/storage/box/vendor_lootbox/medicine_basic/populate_contents()
	if(prob(10)) //Lucky!
		...
		new /obj/item/weapon/storage/deferred/surgery(src)
		new /obj/item/weapon/reagent_containers/syringe/stim/ultra_surgeon(src)
		new /obj/item/weapon/storage/deferred/meds(src)
	else
...
/obj/item/weapon/storage/box/vendor_lootbox/medicine_moderate
...
/obj/item/weapon/storage/box/vendor_lootbox/medicine_moderate/populate_contents()
	if(prob(10)) //Lucky!
		new /obj/item/weapon/storage/firstaid/adv(src)
		new /obj/item/weapon/storage/firstaid/fire(src)
		new /obj/item/weapon/storage/firstaid/toxin(src)
...
/obj/item/weapon/storage/box/vendor_lootbox/medicine_high
...
/obj/item/weapon/storage/box/vendor_lootbox/medicine_high/populate_contents()
	if(prob(10)) //Lucky!
		new /obj/item/weapon/storage/firstaid/adv(src)
		new /obj/item/weapon/storage/firstaid/fire(src)
		new /obj/item/weapon/storage/firstaid/toxin(src)
...
/obj/item/weapon/storage/box/vendor_lootbox/oddity_high
	name = "\"Impossible\" surprise mechanics box"
	desc = "A prospector branded 'surprise mechanics' box, available at the prospector vending machine. While the practice of loading boxes with random junk and selling it lottery style is questionable, \
	people do what they will with their money. Triple oddities in this one! Weird!"

/obj/item/weapon/storage/box/vendor_lootbox/oddity_high/populate_contents()
	if(prob(10)) //Lucky!
		new /obj/random/oddity_guns(src)
	else
		new /obj/random/common_oddities(src)
