...
/obj/effect/flooring_type_spawner/checker_large_fixed
	...
	change_floor_to_path = /turf/simulated/floor/industrial/checker_large_fixed
	icon_state = "concrete_spawner"
