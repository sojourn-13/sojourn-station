...
/obj/structure/closet/secure_closet/personal/prospector/proc/gain_rng()
	main_weapon_cache = pickweight(list("SMG" = 18, "SHOTGUN" = 8, "RIFLE" = 6, "EGUN" = 8, "NEW_SHOTGUN" = 8, "9_SMG" = 12))
	...
	switch(main_weapon_cache)
		...
		if("NEW_SHOTGUN")
			...
			if(prob(50))
				...
				new /obj/item/gun/projectile/automatic/motherfucker(src)
				new /obj/item/ammo_magazine/ammobox/pistol_35/scrap(src)
				new /obj/item/ammo_magazine/ammobox/pistol_35/scrap(src)
		if("SHOTGUN")
			if(prob(50))
				new /obj/item/gun/projectile/shotgun/doublebarrel(src)
		...
		if("9_SMG")
			if(prob(50))
				new /obj/item/gun/projectile/automatic/texan(src)
				new /obj/item/ammo_magazine/smg_35(src)
				new /obj/item/ammo_magazine/smg_35(src)
				new /obj/item/ammo_magazine/smg_35(src)
			else
...
/obj/structure/closet/secure_closet/personal/salvager/proc/gain_rng()
	main_weapon_cache = pickweight(list("SMG" = 12, "NEW_SHOTGUN" = 4, "9_SMG" = 10, "SHOTGUN" = 8, "RIFLE" = 6, "EGUN" = 4))
