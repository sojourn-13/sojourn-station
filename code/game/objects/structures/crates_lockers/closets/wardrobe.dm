...
/obj/structure/closet/wardrobe/militia/accessory/populate_contents()
	...
	new /obj/item/clothing/accessory/bscloak(src)
	new /obj/item/clothing/accessory/bscloak(src)
	new /obj/item/clothing/accessory/cape/blackshield(src)
	new /obj/item/clothing/accessory/cape/blackshield(src)
	new /obj/item/clothing/accessory/cape/blackshield/green(src)
	new /obj/item/clothing/accessory/cape/blackshield/green(src)
	new /obj/item/clothing/accessory/cape/blackshield/tan(src)
	new /obj/item/clothing/accessory/cape/blackshield/tan(src)
	new /obj/item/clothing/accessory/cape/blackshield/camo(src)
	new /obj/item/clothing/accessory/cape/blackshield/camo(src)
