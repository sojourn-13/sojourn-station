...
/obj/random/techpart/item_to_spawn()
	return pickweight(list(
				...
				/obj/item/weapon/computer_hardware/hard_drive/small = 6,
				/obj/item/weapon/computer_hardware/hard_drive/small/adv = 3,
				/obj/item/weapon/computer_hardware/hard_drive = 4,
				/obj/item/weapon/computer_hardware/hard_drive/advanced = 2,
				/obj/item/weapon/computer_hardware/network_card = 6,
				/obj/item/weapon/computer_hardware/network_card/wired = 2,
				...
				/obj/item/weapon/stock_parts/matter_bin = 20,
				...
				/obj/item/weapon/stock_parts/scanning_module/adv = 5,
				...
				/obj/item/weapon/computer_hardware/hard_drive/portable/design/logistics = 1,
