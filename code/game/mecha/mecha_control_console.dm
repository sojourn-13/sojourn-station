/obj/machinery/computer/mecha //Why is this in mecha and not console? // Because everything Mech-related is here. -R4d6
...
/obj/machinery/computer/mecha/proc/print_report(var/mob/living/user)
	var/obj/item/paper/P = new /obj/item/paper(get_turf(src), stored_data, "Exosuit Log")
