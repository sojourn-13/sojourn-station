...
/obj/machinery/bulletfabricator
	...
	var/list/recipes = list(
		...
		"8.6 Heavy Rifle",
			...
			list(name="Heavy Rifle Magazine (8.6 High-velocity)", cost=400, path=/obj/item/ammo_magazine/heavy_rifle_408/hv),
		...
		"8.6 Heavy Rifle, Drum",
			...
			list(name="Heavy Rifle Drum Magazine (8.6mm Drum, High-velocity)", cost=1080, path=/obj/item/ammo_magazine/heavy_rifle_408_drum/slap),
		...
		"8.6, Ammo Boxes",
			...
			list(name="Box (8.6 High-velocity)", cost=4420, path=/obj/item/ammo_magazine/ammobox/heavy_rifle_408/hv),
