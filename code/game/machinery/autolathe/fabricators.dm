/obj/machinery/bulletfabricator
	...
	var/list/recipes = list(
		...
		"9mm Standard",
			...
			list(name="Standard Magazine (9mm Empty Laser)", cost=50, path=/obj/item/ammo_magazine/pistol_35/laser/empty),
		"9mm High Capacity",
		...
		"9mm SMG",
			...
			list(name="SMG Magazine (9mm Empty Laser)", cost=70, path= /obj/item/ammo_magazine/smg_35/laser/empty),
		"9mm Drum",
			...
			list(name="Standard Drum (9mm EmptyLaser)", cost=200, path=/obj/item/ammo_magazine/highcap_pistol_35/drum/laser/empty),
		"9mm Ammo Boxes",
		...
		"10mm Magnum, Pistol",
			...
			list(name="Magnum Magazine (10mm Magnum Empty Laser)", cost=30, path=/obj/item/ammo_magazine/magnum_40/laser/empty),
		"10mm Magnum, SMG",
		...
		"12mm, Heavy Pistol",
			...
			list(name="Heavy Pistol Magazine (12mm Empty Laser)", cost=20, path=/obj/item/ammo_magazine/kurtz_50/laser/empty),
		"12mm, Ammo Boxes",
		...
		"6.5 Carbine, Long",
			...
			list(name="Carbine Magazine (6.5 Empty Laser)", cost=100, path=/obj/item/ammo_magazine/light_rifle_257/laser/empty),
		"6.5 Carbine, Drum",
		...
		"7.62 Rifle",
			...
			list(name="Rifle Magazine (7.62 Empty Laser)", cost=100, path=/obj/item/ammo_magazine/rifle_75/laser/empty),
		"7.62 Rifle, Drum",
		...
		"8.6 Heavy Rifle",
			...
			list(name="Heavy Rifle Magazine (8.6 Empty Laser)", cost=100, path=/obj/item/ammo_magazine/heavy_rifle_408/laser/empty),
