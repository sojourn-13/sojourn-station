...
/obj/machinery/bulletfabricator
	...
	var/list/recipes = list(
		...
		"Shotgun Boxes",
			...
			list(name="Box (20mm Flash)", cost=3080, path=/obj/item/ammo_magazine/ammobox/shotgun/flashshells),
			list(name="Box (20mm Blank)", cost=3080, path=/obj/item/ammo_magazine/ammobox/shotgun/blanks),
			list(name="Box (20mm Practice)", cost=3080, path=/obj/item/ammo_magazine/ammobox/shotgun/practiceshells),
		"Exotic Boxes",
