...
/obj/machinery/bulletfabricator
	...
	var/list/recipes = list(
		...
		"Shotgun",
			...
			list(name="Ammo Drum (20mm Sabot slug)", cost=1080, path=/obj/item/ammo_magazine/m12),
			list(name="Ammo Drum (20mm Empty)", cost=600, path=/obj/item/ammo_magazine/m12/empty),
			list(name="Ammo Drum (20mm Buckshot)", cost=1080, path=/obj/item/ammo_magazine/m12/pellet),
			list(name="Ammo Drum (20mm Beanbag)", cost=1080, path=/obj/item/ammo_magazine/m12/beanbag),
		"Exotic",
		...
		".257 Ammo Packets",
			list(name="Packet (.257 Standard)", cost=990, path=/obj/item/ammo_magazine/ammobox/light_rifle_257_small),
			list(name="Packet (.257 High velocity)", cost=990, path=/obj/item/ammo_magazine/ammobox/light_rifle_257_small/hv),
			list(name="Packet (.257 Hollow-point)", cost=990, path=/obj/item/ammo_magazine/ammobox/light_rifle_257_small/lethal),
			list(name="Packet (.257 Rubber)", cost=990, path=/obj/item/ammo_magazine/ammobox/light_rifle_257/rubber),
			list(name="Packet (.257 Practice)", cost=850, path=/obj/item/ammo_magazine/ammobox/light_rifle_257/practice),
		"7.5 Ammo Packets",
			list(name="Packet (7.5 Standard)", cost=990, path=/obj/item/ammo_magazine/ammobox/rifle_75_small),
			list(name="Packet (7.5 High velocity)", cost=990, path=/obj/item/ammo_magazine/ammobox/rifle_75_small/hv),
			list(name="Packet (7.5 Hollow-point)", cost=990, path=/obj/item/ammo_magazine/ammobox/rifle_75_small/lethal),
		...
		".408 Ammo Boxes",
			...
			list(name="Linked Ammunition Box (.408 Omni Ball)", cost=2820, path=/obj/item/ammo_magazine/rifle_75_linked_box/heavy_rifle_408),
			list(name="Linked Ammunition Box (.408 Omni Hollow Point)", cost=3460, path=/obj/item/ammo_magazine/rifle_75_linked_box/heavy_rifle_408/highvelocity),
			list(name="Linked Ammunition Box (.408 Omni Hollow Point)", cost=3460, path=/obj/item/ammo_magazine/rifle_75_linked_box/heavy_rifle_408/lethal),
			list(name="Linked Ammunition Box (.408 Omni Rubber)", cost=2820, path=/obj/item/ammo_magazine/rifle_75_linked_box/heavy_rifle_408/rubber),
			list(name="Linked Ammunition Box (.408 Omni Empty)", cost=420, path=/obj/item/ammo_magazine/rifle_75_linked_box/heavy_rifle_408/empty),
		"Shotgun Boxes",
