...
/obj/machinery/bulletfabricator
	...
	var/list/recipes = list(
		...
		"Heavy Pistol",
			list(name="Heavy Pistol Magazine (11mm Standard)", cost=100, path=/obj/item/ammo_magazine/kurtz_50),
			list(name="Heavy Pistol Magazine (11mm High velocity)", cost=100, path=/obj/item/ammo_magazine/kurtz_50/hv),
			list(name="Heavy Pistol Magazine (11mm Hollow point)", cost=100, path=/obj/item/ammo_magazine/kurtz_50/lethal),
			list(name="Heavy Pistol Magazine (11mm Rubber)", cost=100, path=/obj/item/ammo_magazine/kurtz_50/rubber),
			list(name="Heavy Pistol Magazine (11mm Practice)", cost=20, path=/obj/item/ammo_magazine/kurtz_50/practice),
		"9mm Speed Loader",
		...
		"11mm Speed Loader",
			list(name="Speed Loader (11mm Special)", cost=60, path=/obj/item/ammo_magazine/speed_loader_kurtz_50),
			list(name="Speed Loader (11mm High-velocity)", cost=60, path=/obj/item/ammo_magazine/speed_loader_kurtz_50/highvelocity),
			list(name="Speed Loader (11mm Hollow-point)", cost=60, path=/obj/item/ammo_magazine/speed_loader_kurtz_50/lethal),
			list(name="Speed Loader (11mm Rubber)", cost=60, path=/obj/item/ammo_magazine/speed_loader_kurtz_50/rubber),
			list(name="Speed Loader (11mm Practice)", cost=20, path=/obj/item/ammo_magazine/speed_loader_kurtz_50/practice),
		"SMG",
		...
		"10x77 Heavy Rifle",
			list(name="Heavy Rifle Magazine (10x77 Standard)", cost=400, path=/obj/item/ammo_magazine/heavy_rifle_408),
			list(name="Heavy Rifle Magazine (10x77 SLAP)", cost=400, path=/obj/item/ammo_magazine/heavy_rifle_408/hv),
			list(name="Heavy Rifle Magazine (10x77 Hollow point)", cost=400, path=/obj/item/ammo_magazine/heavy_rifle_408/lethal),
			list(name="Heavy Rifle Magazine (10x77 Rubber)", cost=400, path=/obj/item/ammo_magazine/heavy_rifle_408/rubber),
			list(name="Heavy Rifle Magazine (10x77 Practice)", cost=100, path=/obj/item/ammo_magazine/heavy_rifle_408/practice),
		"Shotgun",
		...
		"Exotic",
			...
			list(name="Ammo Strip (10x77mm Rifle)", cost=400, path=/obj/item/ammo_magazine/speed_loader_heavy_rifle_408),
			...
			list(name="Heavy Rifle Drum Magazine (10x77mm Drum)", cost=700, path=/obj/item/ammo_magazine/heavy_rifle_408_drum),
			...
			list(name="12.7×108 Anti-Material \"Red-Nose\"", cost=2400, path=/obj/item/ammo_casing/antim/lethal/prespawned),
			list(name="12.7×108 Anti-Material \"Off-Switch\"", cost=2400, path=/obj/item/ammo_casing/antim/ion/prespawned),
		"9mm Ammo Packets",
		...
		"11mm Ammo Boxes",
			list(name="Box (11mm Standard)", cost=330, path=/obj/item/ammo_magazine/ammobox/kurtz_50),
			list(name="Box (11mm High velocity)", cost=330, path=/obj/item/ammo_magazine/ammobox/kurtz_50/hv),
			list(name="Box (11mm Hollow point)", cost=330, path=/obj/item/ammo_magazine/ammobox/kurtz_50/lethal),
			list(name="Box (11mm Rubber)", cost=330, path=/obj/item/ammo_magazine/ammobox/kurtz_50/rubber),
			list(name="Box (11mm Practice)", cost=100, path=/obj/item/ammo_magazine/ammobox/kurtz_50/practice),
		"6.5 Ammo Packets",
		...
		"10x77 Ammo Boxes",
			list(name="Box (10x77 Standard)", cost=3820, path=/obj/item/ammo_magazine/ammobox/heavy_rifle_408),
			list(name="Box (10x77SLAP)", cost=4420, path=/obj/item/ammo_magazine/ammobox/heavy_rifle_408/hv),
			list(name="Box (10x77 Hollow point)", cost=4420, path=/obj/item/ammo_magazine/ammobox/heavy_rifle_408/lethal),
			list(name="Box (10x77 Rubber)", cost=3820, path=/obj/item/ammo_magazine/ammobox/heavy_rifle_408/rubber),
			list(name="Box (10x77 Practice)", cost=200, path=/obj/item/ammo_magazine/ammobox/heavy_rifle_408/practice),
			list(name="Linked Ammunition Box (10x77 Ball)", cost=2820, path=/obj/item/ammo_magazine/rifle_75_linked_box/heavy_rifle_408),
			list(name="Linked Ammunition Box (10x77 Hollow Point)", cost=3460, path=/obj/item/ammo_magazine/rifle_75_linked_box/heavy_rifle_408/highvelocity),
			list(name="Linked Ammunition Box (10x77 Hollow Point)", cost=3460, path=/obj/item/ammo_magazine/rifle_75_linked_box/heavy_rifle_408/lethal),
			list(name="Linked Ammunition Box (10x77 Rubber)", cost=2820, path=/obj/item/ammo_magazine/rifle_75_linked_box/heavy_rifle_408/rubber),
			list(name="Linked Ammunition Box (10x77 Empty)", cost=420, path=/obj/item/ammo_magazine/rifle_75_linked_box/heavy_rifle_408/empty),
		"Shotgun Boxes",
		...
		"Exotic Boxes",
			...
			list(name="Box (12.7×108 AP)", cost=1650, path=/obj/item/ammo_magazine/ammobox/antim),
		"Mech Boxes",
