...
/obj/machinery/bulletfabricator
	...
	var/list/recipes = list(
		...
		"7.62 Rifle, Short",
			...
			list(name="Short Rifle Magazine (7.62 APDS)", cost=300, path=/obj/item/ammo_magazine/rifle_75_short/highvelocity),
		...
		"7.62 Rifle",
			...
			list(name="Rifle Magazine (7.62 APDS)", cost=400, path=/obj/item/ammo_magazine/rifle_75/highvelocity),
		...
		"7.62 Rifle, Drum",
			...
			list(name="Rifle Drum Magazine (7.62 APDS)", cost=1080, path=/obj/item/ammo_magazine/rifle_75_drum/highvelocity),
		...
		"7.62, Ammo Packets",
			...
			list(name="Packet (7.62 APDS)", cost=990, path=/obj/item/ammo_magazine/ammobox/rifle_75_small/hv),
		...
		"7.62, Ammo Boxes",
			...
			list(name="Box (7.62 APDS)", cost=4000, path=/obj/item/ammo_magazine/ammobox/rifle_75/hv),
			...
			list(name="Linked Ammunition Box (7.62mm APDS)", cost=1300, path=/obj/item/ammo_magazine/rifle_75_linked_box/highvelocity),
		...
		"8.6 Heavy Rifle",
			list(name="Heavy Rifle Stripper Clip (8.6mm Rifle)", cost=400, path=/obj/item/ammo_magazine/speed_loader_heavy_rifle_408),
		...
		"8.6 Heavy Rifle, Drum",
			list(name="Heavy Rifle Drum Magazine (8.6mm Drum, Ball)", cost=700, path=/obj/item/ammo_magazine/heavy_rifle_408_drum),
			list(name="Heavy Rifle Drum Magazine (8.6mm Drum, Baton)", cost=700, path=/obj/item/ammo_magazine/heavy_rifle_408_drum/rubber),
			list(name="Heavy Rifle Drum Magazine (8.6mm Drum, Hollow-Tip)", cost=700, path=/obj/item/ammo_magazine/heavy_rifle_408_drum/lethal),
			list(name="Heavy Rifle Drum Magazine (8.6mm Drum, SLAP)", cost=1080, path=/obj/item/ammo_magazine/heavy_rifle_408_drum/slap),
			list(name="Heavy Rifle Drum Magazine (8.6mm Drum, Incendiary)", cost=1620, path=/obj/item/ammo_magazine/heavy_rifle_408_drum/incend),
		"8.6, Ammo Boxes",
			...
			list(name="Linked Ammunition Box (8.6 SLAP)", cost=3460, path=/obj/item/ammo_magazine/rifle_75_linked_box/heavy_rifle_408/highvelocity),
		...
		"20mm Shotgun, Boxes",
			...
			list(name="Box (20mm Incendiary)", cost=4620, path=/obj/item/ammo_magazine/ammobox/shotgun/incendiary),
			list(name="Box (20mm Payload)", cost=7700, path=/obj/item/ammo_magazine/ammobox/shotgun/payload),
		"40mm Grenade",
