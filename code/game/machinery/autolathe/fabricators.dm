/obj/machinery/bulletfabricator
	...
	var/list/recipes = list(
		...
		"Caseless Ammunition",
			...
			list(name="Caseless Pulse Rifle Magazine (10x24mm)", cost=500, path=/obj/item/ammo_magazine/c10x24),
			list(name="Caseless Carbine Magazine (10x24mm)", cost=80, path=/obj/item/ammo_magazine/caseless_10x24),
			list(name="Caseless Heavy Rifle Magazine (8x16mm)", cost=80, path=/obj/item/ammo_magazine/caseless_12x64),
