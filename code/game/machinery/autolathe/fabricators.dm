...
/obj/machinery/bulletfabricator
	...
	var/list/recipes = list(
		...
		".257 Ammo Box",
			...
			list(name="Box (High velocity)", cost=4300, path=/obj/item/ammo_magazine/ammobox/light_rifle_257/lethal),
			list(name="Box (Hollow-point)", cost=4300, path=/obj/item/ammo_magazine/ammobox/light_rifle_257/highvelocity),
