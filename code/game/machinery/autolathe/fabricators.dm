/obj/machinery/bulletfabricator
	...
	var/list/recipes = list(
		...
		"6.5 Carbine, Short",
			...
			list(name="Short Carbine Magazine (High velocity)", cost=300, path=/obj/item/ammo_magazine/ammobox/light_rifle_257_small/hv),
		...
		"6.5 Carbine, Long",
			...
			list(name="Carbine Magazine (High velocity)", cost=450, path=/obj/item/ammo_magazine/light_rifle_257/highvelocity),
		...
		"6.5 Carbine, Drum",
			...
			list(name="Carbine Drum Magazine (High velocity)", cost=1620, path= /obj/item/ammo_magazine/light_rifle_257_drum/highvelocity),
		...
		"8.6 Heavy Rifle",
			list(name="Heavy Rifle Stripper Clip (8.6mm Rifle)", cost=500, path=/obj/item/ammo_magazine/speed_loader_heavy_rifle_408),
			list(name="Heavy Rifle Magazine (8.6 Standard)", cost=500, path=/obj/item/ammo_magazine/heavy_rifle_408),
			list(name="Heavy Rifle Magazine (8.6 SLAP)", cost=750, path=/obj/item/ammo_magazine/heavy_rifle_408/hv),
			list(name="Heavy Rifle Magazine (8.6 Hollow point)", cost=500, path=/obj/item/ammo_magazine/heavy_rifle_408/lethal),
		...
		"8.6, Ammo Packets",
			list(name="Packet (8.6mm Ball)", cost=1200, path=/obj/item/ammo_magazine/ammobox/heavy_rifle_408_small),
