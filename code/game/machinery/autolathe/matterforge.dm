...
//	lst[MATERIAL_RSCRAP] = 0.75			//now guild has a reason to make refined scrap {does not work}
	lst[MATERIAL_AMERIDIAN] = 0.99			//so ameridian is useful to guild now?
//	lst[MATERIAL_BIOMATTER] = 0.2		//church makes so much of it {does not work}
