...
/obj/machinery/vending/greyson_colony_ally
	...
	product_ads = "We thank your colony for saving our Representative in the past! We hope to make more deals for tomorrow!;Hows are you doing?;We really do hope the colony fares well! Contact us anytime soon!;Some people really want to see the world shine!"
	icon = 'icons/obj/machines/one_star/vending.dmi'
	icon_state = "vendor_guns"
	icon_vend = "vendor_printing"
	vendor_department = DEPARTMENT_GREYSON
...
/obj/machinery/vending/greyson_colony_ally/Initialize()
	...
	products = list(
		...
		/obj/item/clothing/under/os_jumpsuit/bdu = 10,
	...
	prices = list(
		/obj/item/clothing/mask/smokable/cigarette/os = 5,
		/obj/item/clothing/head/helmet/space/os = 250,
		/obj/item/clothing/suit/space/os = 350,
		/obj/item/clothing/suit/greatcoat/os = 120,
		/obj/item/clothing/under/os_jumpsuit = 50,
		/obj/item/clothing/under/os_jumpsuit/bdu = 75,
		/obj/item/clothing/under/iron_lock_security = 75,
		/obj/item/clothing/head/os_cap = 45,
		)
