...
/obj/machinery/vending/style
	...
	prices = list(
		...
		//Over Clothing
		/obj/item/clothing/accessory/duster/brown = 95,
		/obj/item/clothing/accessory/duster/chestnut = 95,
		/obj/item/clothing/accessory/duster/crimson = 95,
		/obj/item/clothing/accessory/duster/bloodred = 95,
		/obj/item/clothing/accessory/duster/gauntlet = 95,
		/obj/item/clothing/accessory/duster/ivory = 95,
		/obj/item/clothing/accessory/duster/lumber = 95,
		/obj/item/clothing/accessory/duster/navy = 95,
		/obj/item/clothing/accessory/duster = 95,
		/obj/item/clothing/accessory/duster/cyberpunklong = 95,
		/obj/item/clothing/accessory/duster/cyberpunklong/green = 95,
		/obj/item/clothing/accessory/duster/cyberpunklong/black = 95,
		/obj/item/clothing/accessory/duster/cyberpunklong/white = 95,
		/obj/item/clothing/accessory/duster/bladerunner = 95,
		/obj/item/clothing/accessory/duster/donte = 95,
		/obj/item/clothing/accessory/duster/denton = 95,
