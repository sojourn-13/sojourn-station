...
/obj/machinery/vending/theomat
	...
	products = list(/obj/item/book/ritual/cruciform = 10,
					...
					/obj/item/storage/deferred/meatbox=5,
					/obj/item/storage/deferred/mushbox=5,
					/obj/item/storage/deferred/grainbox=5,
	...
	prices = list(/obj/item/book/ritual/cruciform = 5,
					...
					/obj/item/storage/deferred/meatbox=20,
					/obj/item/storage/deferred/mushbox=20,
					/obj/item/storage/deferred/grainbox=20,
...
/obj/machinery/vending/marshal_kit
	...
	products = list(
		...
		/obj/item/storage/box/m_kit/standard_armor_alt = 5,
	...
	prices = list( // 500$ for default marshal stuff, 750 for the rest
		...
		/obj/item/storage/box/m_kit/standard_armor_alt = 500,
...
/obj/machinery/vending/marshal_kit/proc/RedeemArmor(obj/item/voucher, mob/redeemer)
	var/items = list(
					...
					/obj/item/storage/box/m_kit/standard_armor_alt = "Standard Full Helm",
