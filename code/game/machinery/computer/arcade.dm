...
/obj/machinery/computer/arcade/battle/New()
	...
	name_part1 = pick("Admiral ", "Agent ", "Assassin ", "Anarchist ", "Arms Dealer ", "Arsonist ", "Administrator ", "Abductor ",
					  ...
					  "Head ", "Headhunter ", "Heavyweight ", "Henchman ", "Henchwoman ", "Holoparasite ",
					  "Inquisitor ", "Interferer ", "Inciter ", "Igniter ", "Inspector ",
					  "Jester ", "Judge ", "Juggernaut ", "Jawbreaker ", "Jumbo ",
					  "King ", "Kingpin ", "Killer ", "Kidnapper ", "Knave ",
					  "Leader ", "Legate ", "Lieutenant ", "Lord ", "Lance ",
					  "Mad ", "Magnate ", "Marshal ", "Major ", "Mercenary ", "Master ", "Maverick ", "Malfunctioning AI ",
					  "NeoTheologist ", "Necromancer ", "Ninja ", "Negotiator ",
					  "Overlord ", "Officer ", "Operative ", "Oppressor ",
					  "Prince ", "Princess ", "President ", "Professor ", "Private ", "Prophet ", "Pariah ", "Pirate ",
					  "Queen ",
					  "Raider ", "Ravager ", "Renegade ", "Revolutionary ", "Representative ",
					  "Scavenger ", "Sergeant ", "Serial Killer ", "Serbian ", "Smuggler ", "Swarmer ",
