...
/obj/machinery/computer/arcade/battle/New()
	...
	name_part1 = pick("Admiral ", "Agent ", "Assassin ", "Anarchist ", "Arms Dealer ", "Arsonist ", "Administrator ", "Abductor ", "Baron ", "Bandit ", "Bounty Hunter ", "Blood Cultist ", "Boss ", "Brigadier ", "Bomber ", "Captain ", "Chapter Master ", "Colonel ", "Commander ", "Commodore ", "Count ", "Cultist ", "Crazy ", "Doctor ", "Dread King ", "Duke ", "Deserter ", "Destroyer ", "Deviant ", "Enforcer ", "Emperor ", "Empress ", "Executioner ", "Escaped Prisoner ", "Extorter ", "Forger ", "Fraudster ", "Firestarter ", "First Lieutenant ", "First Officer ", "Fanatic ", "Fugitive ", "Gangster ", "General ", "Gunner ", "Inquisitor ", "Interferer ", "Inciter ", "Igniter ", "King ", "Killer ", "Kidnapper ", "Leader ", "Legate ", "Lieutenant ", "Lord ", "Mad ", "Magnate ", "Mafioso ", "Major ", "Mercenary ", "Master ", "Maverick ", "NeoTheologist ", "Ninja ", "Officer ", "Operative ", "Prince ", "Princess ", "Professor ", "Private ", "Prophet ", "Pariah ", "Pirate ", "Pirate Lord ", "Queen ", "Second Lieutenant ", "Second Officer ", "Secret Agent ", "Sergeant ", "Serial Killer ", "Supreme Commander ", "Serbian ", "Smuggler ", "Traitor ", "Terrorist ", "Thief ", "Trafficker ", "Terroriser ", "Viscount ", "Wanted Criminal ", "Weapons Dealer ", "Warlord ", "Warmonger ", "Zealot ")
