	...
	switch(view)
		if(ORION_VIEW_MAIN)
			if(event == ORION_TRAIL_START) //new game? New game.
				dat = "<center><h1>Chromin Trail[emagged ? ": Realism Edition" : ""]</h1><br>Learn how our ancestors got to Chromin 8, and have fun in the process!</center><br><P ALIGN=Right><a href='byond://?src=\ref[src];continue=1'>Start New Game</a></P>"
