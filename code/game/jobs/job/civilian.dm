...
/datum/job/clubmanager
	...
	description = "As the Club Manager, you run the club aboard the CEV Eris. Provide the crewmembers with drinks, food, and entertainment.<br>\
	Technically you take orders from noone, but the Captain and the First Officer are the ones who hired you - thus, strive to please them.<br>\
	Your Club Workers help you run the place and make money. Pay them well!"
...
/datum/job/actor
	...
	The Captain pays you a terrible retaining fee, so try to make some money from audience donations to live well."
