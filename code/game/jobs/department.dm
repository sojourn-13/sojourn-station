...
/datum/department/prospector
	...
	account_initial_balance = 6500 //Starts with an even wage to cover payment-expenses. Their job is to make money and, thus, should not start with more money than needed.
