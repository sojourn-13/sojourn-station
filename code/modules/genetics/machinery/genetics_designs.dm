/* =================Designs=================
Designs for various genetics components
...
/datum/design/autolathe/genetics/clone_console
	name = "Vat Control Console Board"
...
/datum/design/autolathe/genetics/petite_scanner
	name = "Small Mutagenic Scanner"
	build_path = /obj/item/device/scanner/petite_scanner

/datum/design/research/item/petite_scanner
	name = "Small Mutagenic Scanner"
	desc = "A petite device for analyzing genetic instability."
	build_path = /obj/item/device/scanner/petite_scanner
	category = "Medical"