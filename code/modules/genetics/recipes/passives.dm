...
/datum/genetics/mutation_recipe/combination/mend_r
	required_mutations = list(MUTATION_GENE_MENDING, MUTATION_EPILEPSY)
	result_path = MUTATION_GENE_MENDING_R

/datum/genetics/mutation_recipe/combination/mend_h
	required_mutations = list(MUTATION_GENE_MENDING, MUTATION_NERVOUSNESS)
