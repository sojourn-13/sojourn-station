...
/datum/category_item/player_setup_item/physical/basic/content()
	...
	. += "<hr>"
	. += "<b>Species Name:</b> <a href='byond://?src=\ref[src];species_aan=1'>A[pref.species_aan]</a><a href='byond://?src=\ref[src];species_name=1'>[pref.custom_species]</a>"
	. += "<a href='byond://?src=\ref[src];species_name_color=1'><span class='color_holder_box' style='background-color:[pref.species_color]'></span></a><br>"

	. += "<b>Sex:</b> <a href='byond://?src=\ref[src];gender=1'>[gender2text(pref.gender)]</a><br>"
	. += "<b>Gender Identity:</b> <a href='byond://?src=\ref[src];gender_identity=1'>[pref.gender_identity ? gender2text(pref.gender_identity) : "Default"]</a><br>"
	. += "<b>Age:</b> <a href='byond://?src=\ref[src];age=1'>[pref.age]</a><br>"
	. += "<b>Blood Type:</b> <a href='byond://?src=\ref[src];blood_type=1'>[pref.b_type]</a><br>"
	. += "<b>Needs Glasses:</b> <a href='byond://?src=\ref[src];disabilities=[NEARSIGHTED]'><b>[pref.disabilities & NEARSIGHTED ? "Yes" : "No"]</b></a><br>"
