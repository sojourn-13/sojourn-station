...
/datum/category_item/player_setup_item/background/education/content(var/mob/user)
	. = list()
	. += "<br/><b>Skills</b>:<br/>"
	. += "Biology: <a href='byond://?src=\ref[src];biomod=1'>[pref.BIOMOD]</a><br>"
	. += "Cognition: <a href='byond://?src=\ref[src];cogmod=1'>[pref.COGMOD]</a><br>"
	. += "Mechanical: <a href='byond://?src=\ref[src];mecmod=1'>[pref.MECMOD]</a><br>"
	. += "Robustness:  <a href='byond://?src=\ref[src];robmod=1'>[pref.ROBMOD]</a><br>"
	. += "Toughness:  <a href='byond://?src=\ref[src];tghmod=1'>[pref.TGHMOD]</a><br>"
	. += "Vigilance:  <a href='byond://?src=\ref[src];vigmod=1'>[pref.VIGMOD]</a><br>"
	. += "Vivification:  <a href='byond://?src=\ref[src];vivmod=1'>[pref.VIVMOD]</a><br>"
	. += "Anatomy:  <a href='byond://?src=\ref[src];anamod=1'>[pref.ANAMOD]</a><br>"
	. += "<br/>"
	...
	. += "Cap-Biology-At: <a href='byond://?src=\ref[src];bio_cap=1'>[pref.BIO_CAP]</a><br>"
	. += "Cap-Cognition-At: <a href='byond://?src=\ref[src];cog_cap=1'>[pref.COG_CAP]</a><br>"
	. += "Cap-Mechanical-At: <a href='byond://?src=\ref[src];mec_cap=1'>[pref.MEC_CAP]</a><br>"
	. += "Cap-Robustness-At:  <a href='byond://?src=\ref[src];rob_cap=1'>[pref.ROB_CAP]</a><br>"
	. += "Cap-Toughness-At:  <a href='byond://?src=\ref[src];tgh_cap=1'>[pref.TGH_CAP]</a><br>"
	. += "Cap-Vigilance-At:  <a href='byond://?src=\ref[src];vig_cap=1'>[pref.VIG_CAP]</a><br>"
	. += "Cap-Vivification-At:  <a href='byond://?src=\ref[src];viv_cap=1'>[pref.VIV_CAP]</a><br>"
	. += "Cap-Anatomy-At:  <a href='byond://?src=\ref[src];ana_cap=1'>[pref.ANA_CAP]</a><br>"
