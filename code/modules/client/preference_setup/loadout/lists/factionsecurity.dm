/datum/gear/factionsecurity
	...
	allowed_roles = list("Blackshield Commander","Warrant Officer","Supply Specialist","Squad Leader","Ranger","Corpsman","Blackshield Trooper","Marshal Officer")
	slot = slot_wear_suit
...
/datum/gear/factionsecurity/beretwarden
	...
	allowed_roles = list("Supply Specialist","Squad Leader")
	slot = slot_head
	sort_category = "Faction: Security"
...
/datum/gear/factionsecurity/gloves
	...
	allowed_roles = list("Blackshield Commander","Squad Leader","Corpsman","Blackshield Trooper")
	slot = slot_gloves
	sort_category = "Faction: Security"
...
/datum/gear/factionsecurity/jumpskirtoperative
	...
	allowed_roles = list("Supply Specialist","Squad Leader","Ranger","Corpsman","Blackshield Trooper","Marshal Officer")
	slot = slot_w_uniform
	sort_category = "Faction: Security"
