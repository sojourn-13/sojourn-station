...
/datum/gear/factionsoteria/gorka_crew_med
	...
	allowed_roles = list("Soteria Doctor","Chief Biolab Overseer","Soteria Chemist","Soteria Paramedic")
	slot = slot_wear_suit
	sort_category = "Faction: Soteria"
...
/datum/gear/factionsoteria/scrubs
	...
	allowed_roles = list("Soteria Paramedic","Soteria Psychiatrist","Soteria Chemist","Soteria Doctor","Chief Biolab Overseer")
	slot = slot_w_uniform
	sort_category = "Faction: Soteria"
