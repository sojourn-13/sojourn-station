...
/datum/gear/factionsoteria/cloakmedical
	...
	allowed_roles = list("Soteria Doctor","Soteria Biolab Officer","Soteria Orderly","Soteria Recovery Team")
	slot = slot_wear_suit
	sort_category = "Faction: Soteria"
...
/datum/gear/factionsoteria/scrubs
	...
	allowed_roles = list("Soteria Psychiatrist","Soteria Recovery Team","Soteria Doctor","Chief Biolab Overseer")
	slot = slot_w_uniform
	sort_category = "Faction: Soteria"
...
/datum/gear/factionsoteria/snowsuitmedical
	...
	allowed_roles = list("Soteria Psychiatrist","Soteria Orderly","Soteria Recovery Team","Chief Biolab Overseer")
	slot = slot_wear_suit
	sort_category = "Faction: Soteria"
