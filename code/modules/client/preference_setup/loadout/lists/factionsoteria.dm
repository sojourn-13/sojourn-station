...
/datum/gear/factionsoteria/cloakmedical
	...
	allowed_roles = list("Soteria Doctor","Soteria Biolab Officer","Soteria Orderly","Soteria Paramedic")
	slot = slot_wear_suit
	sort_category = "Faction: Soteria"
...
/datum/gear/factionsoteria/gorka_crew_med
	...
	allowed_roles = list("Soteria Doctor","Chief Biolab Overseer","Soteria Orderly","Soteria Paramedic")
	slot = slot_wear_suit
	sort_category = "Faction: Soteria"
