...
/datum/gear/factionsoteria/cloakmedical
	...
	allowed_roles = list("Soteria Doctor","Soteria Biolab Officer","Soteria Paramedic", "Soteria Medical Resident")
	slot = slot_wear_suit
	sort_category = "Faction: Soteria"
...
/datum/gear/factionsoteria/si_bdu
	...
	allowed_roles = list("Soteria Doctor","Chief Biolab Overseer","Soteria Paramedic", "Soteria Medical Resident")
	slot = slot_wear_suit
	sort_category = "Faction: Soteria"
...
/datum/gear/factionsoteria/gorka_crew_sci
	...
	allowed_roles = list("Chief Research Overseer","Soteria Scientist","Soteria Paramedic")
	slot = slot_wear_suit
	sort_category = "Faction: Soteria"
...
/datum/gear/factionsoteria/gorkamoebiusmedical
	...
	allowed_roles = list("Soteria Doctor","Chief Biolab Overseer","Soteria Paramedic")
	slot = slot_w_uniform
	sort_category = "Faction: Soteria"
...
/datum/gear/factionsoteria/medicalscouter
	...
	allowed_roles = list("Chief Biolab Overseer","Soteria Doctor","Soteria Paramedic","Corpsman", "Soteria Medical Resident")
	sort_category = "Faction: Soteria"
...
/datum/gear/factionsoteria/scrubs
	...
	allowed_roles = list("Soteria Psychiatrist","Soteria Paramedic","Soteria Doctor","Chief Biolab Overseer", "Soteria Medical Resident")
	slot = slot_w_uniform
	sort_category = "Faction: Soteria"
...
/datum/gear/factionsoteria/snowsuitmedical
	...
	allowed_roles = list("Soteria Psychiatrist","Soteria Orderly","Soteria Paramedic","Chief Biolab Overseer", "Soteria Medical Resident")
	slot = slot_wear_suit
	sort_category = "Faction: Soteria"
...
/datum/gear/factionsoteria/winterbootsmedical
	...
	allowed_roles = list("Soteria Psychiatrist","Soteria Paramedic","Soteria Doctor","Chief Biolab Overseer")
	slot = slot_shoes
	sort_category = "Faction: Soteria"
...
/datum/gear/factionsoteria/penlight
	...
	allowed_roles = list("Soteria Paramedic","Soteria Doctor","Chief Biolab Overseer", "Soteria Medical Resident")
	slot = slot_r_ear
	sort_category = "Faction: Soteria"
	cost = 0
