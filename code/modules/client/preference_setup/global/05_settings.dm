...
/datum/category_item/player_setup_item/player_global/settings/load_preferences(var/savefile/S)
	...
	from_file(S["securityplaytime"], pref.securityplaytime)
	from_file(S["medicalplaytime"], pref.medicalplaytime)
	from_file(S["engineeringplaytime"], pref.engineeringplaytime)
	from_file(S["scienceplaytime"], pref.scienceplaytime)
	from_file(S["lonestarplaytime"], pref.lonestarplaytime)
	from_file(S["churchplaytime"], pref.churchplaytime)
	from_file(S["prospectorsplaytime"], pref.prospectorsplaytime)
	from_file(S["independentplaytime"], pref.independentplaytime)
	from_file(S["commandplaytime"], pref.commandplaytime)
...
/datum/category_item/player_setup_item/player_global/settings/save_preferences(var/savefile/S)
	...
	to_file(S["securityplaytime"], pref.securityplaytime)
	to_file(S["medicalplaytime"], pref.medicalplaytime)
	to_file(S["engineeringplaytime"], pref.engineeringplaytime)
	to_file(S["scienceplaytime"], pref.scienceplaytime)
	to_file(S["lonestarplaytime"], pref.lonestarplaytime)
	to_file(S["churchplaytime"], pref.churchplaytime)
	to_file(S["prospectorsplaytime"], pref.prospectorsplaytime)
	to_file(S["independentplaytime"], pref.independentplaytime)
	to_file(S["commandplaytime"], pref.commandplaytime)
