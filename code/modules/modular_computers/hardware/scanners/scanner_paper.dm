/obj/item/pc_part/scanner/paper
...
/obj/item/pc_part/scanner/paper/can_use_scanner(mob/user, obj/item/paper/target, proximity = TRUE)
	if(!..())
		return 0
	if(!istype(target))
		return 0
...
/obj/item/pc_part/scanner/paper/do_on_afterattack(mob/user, obj/item/paper/target, proximity)
...
/obj/item/pc_part/scanner/paper/do_on_attackby(mob/user, atom/target)
