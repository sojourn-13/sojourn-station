...
/datum/cooking_with_jane/recipe/sandwich_basic_bowl
	...
	step_builder = list(
		...
		list(CWJ_ADD_ITEM, /obj/item/reagent_containers/snacks/cutlet, qmod=0.5, desc="Add any kind of cutlet.", prod_desc="There is meat between the bread."),
		list(CWJ_ADD_ITEM, /obj/item/reagent_containers/snacks/breadslice, qmod=0.5)
	)
...
/datum/cooking_with_jane/recipe/sandwich_bad_with_tomato
	...
	step_builder = list(
		list(CWJ_ADD_ITEM, /obj/item/reagent_containers/snacks/breadslice, qmod=0.5),
		list(CWJ_ADD_ITEM, /obj/item/reagent_containers/snacks/cutlet, desc="Add any kind of cutlet.", prod_desc="There is meat between the bread."),
...
/datum/cooking_with_jane/recipe/sandwich_tofu_bad
	...
	step_builder = list(
		...
		list(CWJ_ADD_ITEM_OPTIONAL, /obj/item/reagent_containers/snacks/tofu, desc="Add tofu to it.", prod_desc="There is tofu between the bread."),
		list(CWJ_USE_ITEM_OPTIONAL, /obj/item/reagent_containers/snacks/tofu, desc="Brush Tofu on it.", prod_desc="It has been in contact with tofu."),
...
/datum/cooking_with_jane/recipe/sandwich_bad_stacked
	...
	step_builder = list(
		list(CWJ_ADD_ITEM, /obj/item/reagent_containers/snacks/breadslice, qmod=0.5),
		list(CWJ_ADD_ITEM, /obj/item/reagent_containers/snacks/cutlet, desc="Add any kind of cutlet.", prod_desc="There is meat between the bread."),
		list(CWJ_ADD_ITEM_OPTIONAL, /obj/item/reagent_containers/snacks/cutlet, desc="Add even more of any kind of cutlet.", prod_desc="There is additional meat between the bread."),
		list(CWJ_ADD_ITEM, /obj/item/reagent_containers/snacks/breadslice)
	)
	appear_in_default_catalog = FALSE
...
/datum/cooking_with_jane/recipe/sandwich_toasted
	...
	product_type = /obj/item/reagent_containers/snacks/sandwich
	step_builder = list(
		list(CWJ_ADD_ITEM, /obj/item/reagent_containers/snacks/sandwich),
