...
/datum/cooking_with_jane/recipe/dough
	...
	step_builder = list(
		list(CWJ_ADD_ITEM, /obj/item/reagent_containers/snacks/egg, qmod=1),
...
/datum/cooking_with_jane/recipe/kneaded_dough
	...
	product_type = /obj/item/reagent_containers/snacks/dough
	step_builder = list(
		list(CWJ_ADD_ITEM, /obj/item/reagent_containers/snacks/dough, qmod=1, max=70),
...
/datum/cooking_with_jane/recipe/kneaded_dough_batch
	...
	product_count = 5
	step_builder = list(
		list(CWJ_ADD_ITEM, /obj/item/reagent_containers/snacks/dough, qmod=0.2, max=70),
		list(CWJ_ADD_ITEM, /obj/item/reagent_containers/snacks/dough, qmod=0.2, max=70),
		list(CWJ_ADD_ITEM, /obj/item/reagent_containers/snacks/dough, qmod=0.2, max=70),
		list(CWJ_ADD_ITEM, /obj/item/reagent_containers/snacks/dough, qmod=0.2, max=70),
		list(CWJ_ADD_ITEM, /obj/item/reagent_containers/snacks/dough, qmod=0.2, max=70),
