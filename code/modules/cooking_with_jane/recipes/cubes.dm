/datum/cooking_with_jane/recipe/cube_kampfer
	...
	product_type = /obj/item/reagent_containers/food/snacks/cube/roach
	step_builder = list(
...
/datum/cooking_with_jane/recipe/cube_fuhrer
	...
	cooking_container = CUTTING_BOARD
	product_type = /obj/item/reagent_containers/food/snacks/cube/roach/fuhrer
	step_builder = list(
		list(CWJ_ADD_ITEM, /obj/item/reagent_containers/food/snacks/meat/roachmeat/fuhrer, qmod=0.2),
		list(CWJ_ADD_PRODUCE, "potato", reagent_skip=TRUE),
		list(CWJ_ADD_ITEM, /obj/item/reagent_containers/food/snacks/meat/roachmeat/fuhrer, qmod=0.2),
		list(CWJ_ADD_PRODUCE, "potato", reagent_skip=TRUE),
...
/datum/cooking_with_jane/recipe/cube_jager
	...
	cooking_container = CUTTING_BOARD
	product_type = /obj/item/reagent_containers/food/snacks/cube/roach/jager
	step_builder = list(
...
/datum/cooking_with_jane/recipe/cube_kraftwerk
	...
	cooking_container = CUTTING_BOARD
	product_type = /obj/item/reagent_containers/food/snacks/cube/roach/kraftwerk
	step_builder = list(
		list(CWJ_ADD_ITEM, /obj/item/reagent_containers/food/snacks/meat/roachmeat/kraftwerk, qmod=0.2),
...
/datum/cooking_with_jane/recipe/cube_elektromagnetisch
	...
	cooking_container = CUTTING_BOARD
	product_type = /obj/item/reagent_containers/food/snacks/cube/roach/elektromagnetisch
	step_builder = list(
		list(CWJ_ADD_ITEM, /obj/item/reagent_containers/food/snacks/meat/roachmeat/elektromagnetisch, qmod=0.2),
...
/datum/cooking_with_jane/recipe/cube_glowing
	...
	cooking_container = CUTTING_BOARD
	product_type = /obj/item/reagent_containers/food/snacks/cube/roach/glowing
	step_builder = list(
		list(CWJ_ADD_ITEM, /obj/item/reagent_containers/food/snacks/meat/roachmeat/glowing, qmod=0.2),
...
/datum/cooking_with_jane/recipe/cube_roachling
	...
	cooking_container = CUTTING_BOARD
	product_type = /obj/item/reagent_containers/food/snacks/cube/roach/roachling
	step_builder = list(
		list(CWJ_ADD_ITEM, /obj/item/reagent_containers/food/snacks/meat/roachmeat, qmod=0.2),
...
/datum/cooking_with_jane/recipe/cube_seuche
	...
	cooking_container = CUTTING_BOARD
	product_type = /obj/item/reagent_containers/food/snacks/cube/roach/seuche
	step_builder = list(
...
/datum/cooking_with_jane/recipe/cube_panzer
	...
	cooking_container = CUTTING_BOARD
	product_type = /obj/item/reagent_containers/food/snacks/cube/roach/panzer
	step_builder = list(
		list(CWJ_ADD_ITEM, /obj/item/reagent_containers/food/snacks/meat/roachmeat/panzer, qmod=0.2),
		list(CWJ_ADD_ITEM, /obj/item/reagent_containers/food/snacks/meat/roachmeat/panzer, qmod=0.2),
...
/datum/cooking_with_jane/recipe/cube_grestrahlte
	...
	cooking_container = CUTTING_BOARD
	product_type = /obj/item/reagent_containers/food/snacks/cube/roach/grestrahlte
	step_builder = list(
		list(CWJ_ADD_ITEM, /obj/item/reagent_containers/food/snacks/meat/roachmeat, qmod=0.2),
