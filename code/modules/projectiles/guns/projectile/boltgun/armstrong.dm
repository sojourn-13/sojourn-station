...
/obj/item/gun/projectile/boltgun/lever/custer
	...
	gun_parts = list(/obj/item/part/gun/frame/armstrong = 1, /obj/item/part/gun/grip/wood = 1, /obj/item/part/gun/mechanism/boltgun = 1, /obj/item/part/gun/barrel/hrifle = 1)
