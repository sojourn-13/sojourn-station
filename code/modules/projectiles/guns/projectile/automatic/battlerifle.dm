...
/obj/item/gun/projectile/automatic/omnirifle/hustler
	...
	gun_parts = list(/obj/item/part/gun/frame/omni = 1, /obj/item/part/gun/grip/wood = 1, /obj/item/part/gun/mechanism/autorifle = 1, /obj/item/part/gun/barrel/shotgun = 1)
	price_tag = 2000
	penetration_multiplier = 1.1
