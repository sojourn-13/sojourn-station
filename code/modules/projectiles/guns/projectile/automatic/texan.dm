/obj/item/weapon/gun/projectile/automatic/texan
	name = "\"Texan\" SMG"
	desc = "The Texan is a cheap self-defence weapon, mass-produced by \"Scarborough Arms\" for raiding parities in tight ship hall, with a moderate effectiveness against soft body armor. Uses .35 rounds."
