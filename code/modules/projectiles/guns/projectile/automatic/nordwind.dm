...
/obj/item/gun/projectile/automatic/nordwind/strelki
	...
	desc = "A Strelki precision rifle, an inexpensive rifle of decent quality made by Hunt Inc.\
			Its mostly wooden design and its usage of 7.5mm rounds make it the ideal weapon for a hunter tired of a crude bolt action. The frontier's favorite sniper!"
