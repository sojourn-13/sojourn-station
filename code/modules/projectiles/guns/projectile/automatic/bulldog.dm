...
/obj/item/part/gun/frame/bulldog
	name = "Bull-series frame"
	desc = "A Bull-series frame. Predecesor to the Wind-series, remains largely popular with low budget security firms. Can be assembled into carbines."
