/obj/item/gun/projectile/automatic/triage
	...
	desc = "A bullpup SMG chambered in .40. \
	Created in collaboration with the Vesalius-Andra R&D division using jury-rigged greyson miniaturization designs to create a compact and lightweight SMG. \
