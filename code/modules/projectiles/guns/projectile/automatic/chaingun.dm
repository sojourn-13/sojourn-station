...
/obj/item/gun/projectile/automatic/chaingun
	...
	It is chambered in 10x77mm and has feeding systems for drums and linkless ammunition boxes. This one is fitted with a tactical sight and a gyrostabilizer. A weapon fit to slay even the hordes of Hell."
