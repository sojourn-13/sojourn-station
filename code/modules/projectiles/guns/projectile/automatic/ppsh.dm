/obj/item/gun/projectile/automatic/ppsh
	...
	desc = "\"We are spiritual wanderers, poor in spirit. What do we live on? We live from the pure hatred we feel. We cannot love anyone. We destroy things, we shout them, we burn them.\"\nAn experimental sub-machine gun design made for urban combat with a built in silencer and chambered in 9mm. For the union, for the future." //It can infact take both now for some reason so no reason for the "can only take drums"
...
/obj/item/part/gun/frame/ppsh
	...
	resultvars = list(/obj/item/gun/projectile/automatic/ppsh, /obj/item/gun/projectile/automatic/ppsh/NM_colony)
