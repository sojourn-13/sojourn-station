/obj/item/gun/projectile/shotgun/sbaw
...
/obj/item/gun/projectile/shotgun/sbaw/update_icon()
	..()
...
/obj/item/gun/projectile/shotgun/sbaw/Initialize()
	. = ..()
	launcher = new(src)
	update_icon()

/obj/item/gun/projectile/shotgun/sbaw/attackby(obj/item/I, mob/user)
	if((istype(I, /obj/item/ammo_casing/grenade)))
		launcher.load_ammo(I, user)
	else
		..()

/obj/item/gun/projectile/shotgun/sbaw/attack_hand(mob/user)
...
/obj/item/gun/projectile/shotgun/sbaw/Fire(atom/target, mob/living/user, params, pointblank=0, reflex=0)
	var/datum/firemode/cur_mode = firemodes[sel_mode]
...
/obj/item/gun/projectile/shotgun/sbaw/examine(mob/user)
	..()
...
/obj/item/gun/projectile/shotgun/sbaw/admin
