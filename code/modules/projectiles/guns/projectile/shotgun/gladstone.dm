...
/obj/item/gun/projectile/shotgun/pump/gladstone/queen
	...
	This particular shotgun was originally a Gladstone, remodeled and reforged by Jea Smails, first Matriarch and founder of the Hunting Lodge. It was destroyed by a careless hunt master, only \
	...
	icon_state = "queen"
	item_state = "queen"
	fire_sound = 'sound/weapons/guns/fire/rushingbull.ogg' // Snowflake gun
	origin_tech = list(TECH_COMBAT = 4, TECH_MATERIAL = 2)
	max_shells = 14 //half a box in this massive gun
	caliber = CAL_SHOTGUN
	w_class = ITEM_SIZE_HUGE
	damage_multiplier = 1.1
	proj_pve_damage_multiplier = 3 // Strong enough to hunt Leviathan-class megafauna with.
	ammo_type = /obj/item/ammo_casing/shotgun
