...
/obj/item/gun/projectile/revolver/lemant/deacon
...
/obj/item/gun/projectile/revolver/lemant/deacon/Initialize()
	. = ..()
	launcher = new(src)

/obj/item/gun/projectile/revolver/lemant/deacon/attackby(obj/item/I, mob/user)
	if((istype(I, /obj/item/ammo_casing/grenade)))
		launcher.load_ammo(I, user)
	else
		..()

/obj/item/gun/projectile/revolver/lemant/deacon/attack_hand(mob/user)
	var/datum/firemode/cur_mode = firemodes[sel_mode]
...
/obj/item/gun/projectile/revolver/lemant/deacon/Fire(atom/target, mob/living/user, params, pointblank=0, reflex=0)
	var/datum/firemode/cur_mode = firemodes[sel_mode]
...
/obj/item/gun/projectile/revolver/lemant/deacon/examine(mob/user)
	..()
