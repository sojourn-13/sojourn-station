/obj/item/gun/projectile/revolver/deckard
	...
	desc = "A rare, custom-built revolver formerly used by early Mar'qua Empire Turing Police. Use when there is no time for the Voight-Kampff test. Uses .50 Kurtz."
