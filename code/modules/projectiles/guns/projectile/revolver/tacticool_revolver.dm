/obj/item/gun/projectile/revolver/tacticool_revolver
	...
	desc = "When people complained that the Mateba was impractical due to its wrist snapping recoil, Scarborough Arms decided what it really needed was a tactical scope for sniping. Uses 11mm."
