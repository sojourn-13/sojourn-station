/obj/item/weapon/gun/energy/sst
	...
	desc = "\"Soteria Surface Tension\" brand handgun. A cooperative project between Soteria Medical and Soteria Research, the Abnegate uses Greyson tech to internally synthesize soporific coated .35 calliber bullets. Initially designed at the request of orderlies for a proper way to sedate rowdy armored targets from a distance."
...
/obj/item/weapon/gun/energy/sst/formatbound
	...
	desc = "\"Soteria Surface Tension\" brand heavy handgun. Further development on the cooperative project between Soteria Medical and Soteria Research known as Soteria Surface Tension. This heavy handgun fires a stronger bullet and carries more anesthetics, for the stubborn person that won't get out of your medical bay."
...
/obj/item/weapon/gun/energy/sst/humility
	...
	desc = "\"Soteria Surface Tension\" brand semi-automatic shotgun. Larger threats demanded larger ordinance and Soteria responded to the internal need for such equipment. Its internal mechanism prints out soporific coated ammunition as it fires. The Humility has the firepower to down larger monstrous targets as well as stop anyone why may be posing a threat to Soteria Medical. "
...
/obj/item/weapon/gun/energy/sst/systemcost
	...
	desc = "\"Soteria Surface Tension\" brand light machinegun. The true answer to a horde of either monsters or rubberneckers in the medical bay. Able to fire soporific coated bullets at a high rate of fire, the System Cost is an orderly's dream come true."
