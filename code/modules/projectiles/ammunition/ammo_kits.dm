...
/proc/make_scrap_ammo(mob/living/user, obj/source, extra_material_points = 0)
	...
	var/list/array = list(
		...
		CAL_HRIFLE = list(
			"10x77mm heavy rifle ammo pile (10 ammo, 3 points)" = list(3, /obj/item/ammo_casing/heavy_rifle_408/scrap),
			"10x77mm heavy rifle standard magazine (empty, 20 ammo, 5 points)" = list(5, /obj/item/ammo_magazine/heavy_rifle_408/scrap/empty),,
			"10x77mm heavy rifle drum magazine (empty, 36 ammo, 30 points)" = list(30, /obj/item/ammo_magazine/heavy_rifle_408_drum/empty),
			"10x77mm heavy rifle ammo box (40 ammo, 15 points)" = list(15, /obj/item/ammo_magazine/ammobox/heavy_rifle_408_small/scrap)),
		CAL_PISTOL = list(
