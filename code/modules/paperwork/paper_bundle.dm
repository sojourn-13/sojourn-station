...
/obj/item/paper_bundle/proc/show_content(mob/user as mob)
	...
	// first
	if(page == 1)
		pages_header+= "<DIV STYLE='float:left; text-align:left; width:33.33333%'><a href='byond://?src=\ref[src];prev_page=1'>Front</A></DIV>"
		pages_header+= "<DIV STYLE='float:left; text-align:center; width:33.33333%'><a href='byond://?src=\ref[src];remove=1'>Remove [(istype(W, /obj/item/paper)) ? "paper" : "photo"]</A></DIV>"
		pages_header+= "<DIV STYLE='float:left; text-align:right; width:33.33333%'><a href='byond://?src=\ref[src];next_page=1'>Next Page</A></DIV><BR><HR>"
	// last
	else if(page == pages.len)
		pages_header+= "<DIV STYLE='float:left; text-align:left; width:33.33333%'><a href='byond://?src=\ref[src];prev_page=1'>Previous Page</A></DIV>"
		pages_header+= "<DIV STYLE='float:left; text-align:center; width:33.33333%'><a href='byond://?src=\ref[src];remove=1'>Remove [(istype(W, /obj/item/paper)) ? "paper" : "photo"]</A></DIV>"
		pages_header+= "<DIV STYLE='float;left; text-align:right; with:33.33333%'><a href='byond://?src=\ref[src];next_page=1'>Back</A></DIV><BR><HR>"
	// middle pages
	else
		pages_header+= "<DIV STYLE='float:left; text-align:left; width:33.33333%'><a href='byond://?src=\ref[src];prev_page=1'>Previous Page</A></DIV>"
		pages_header+= "<DIV STYLE='float:left; text-align:center; width:33.33333%'><a href='byond://?src=\ref[src];remove=1'>Remove [(istype(W, /obj/item/paper)) ? "paper" : "photo"]</A></DIV>"
