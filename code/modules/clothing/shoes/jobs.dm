...
/obj/item/clothing/shoes/dutyboots
	...
	icon_state = "duty"
	force = WEAPON_FORCE_HARMLESS
	armor_list = list(melee = 15, bullet = 10, energy = 0, bomb = 0, bio = 25, rad = 0)
...
/obj/item/clothing/shoes/dutyboots/heel
	name = "knee-high heeled duty boots"
	desc = "A pair of standard-issue police steel-toed boots. They look like they were designed for different kind of service."
