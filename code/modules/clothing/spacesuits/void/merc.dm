...
/obj/item/clothing/head/helmet/space/void/merc/xanaroth
	name = "xanaroth voidsuit helmet"
	desc = "A crimson helmet sporting clean lines and durable plating. Engineered to look menacing. This one is branded with a small rune at the back of the neck noting it was made by the Xanaroth Syndicate."

/obj/item/clothing/suit/space/void/merc/xanaroth
	name = "xanaroth voidsuit"
	desc = "A crimson spacesuit sporting clean lines and durable plating. Robust, reliable, and slightly suspicious. This one is branded with a small rune at the collar noting it was made by the Xanaroth Syndicate."
	helmet = /obj/item/clothing/head/helmet/space/void/merc/xanaroth
	price_tag = 650
