...
/obj/item/clothing/suit/storage/vest/merc
	...
	desc = "A high-quality armor vest in a fetching tan. It is surprisingly flexible and light, even with the added webbing and armor plating. It can also accept up to two armor upgrades, if you have them."
