...
/obj/item/clothing/head/helmet/ballistic/militia/toggle_style()
	...
	var/mob/M = usr
	var/list/options = list()
	options["Default Blackshield Combat"] = "helmet_mil_alt"
	...
	options["Arctic Blackshield Combat"] = "helmet_white_mil"
	options["Arctic Blackshield Combat - Anthromorphic"] = "helmet_white_mil_anthro"
...
/obj/item/clothing/head/helmet/ballistic/militia/full/toggle_style()
	...
	options["Arctic Blackshield Combat"] = "_white"
	options["Arctic Blackshield Combat - Anthromorphic"] = "_white_anthro"
	...
	options["Arctic Camo Combat - Hooded"] = "_wp"
	var/choice = input(M,"What kind of style do you want?","Adjust Style") as null|anything in options
...
/obj/item/clothing/head/helmet/faceshield/altyn/milisha/toggle_style()
	...
	options["Arctic Blackshield Combat"] = "maska_bs_white"
