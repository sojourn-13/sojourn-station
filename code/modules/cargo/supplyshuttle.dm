...
/obj/structure/plasticflaps/CanPass(atom/A, turf/T)
	...
	if (istype(A, /obj/structure/bed) && B.buckled_mob)//if it's a bed/chair and someone is buckled, it will not pass
		...
		var/mob/living/M = A
		if(!M.lying && !istype(M, /mob/living/carbon/human/monkey) && !istype(M, /mob/living/carbon/slime) && !istype(M, /mob/living/simple/mouse) && !istype(M, /mob/living/silicon/robot/drone))  //If your not laying down, or a small creature, no pass.
			return 0
	return ..()
