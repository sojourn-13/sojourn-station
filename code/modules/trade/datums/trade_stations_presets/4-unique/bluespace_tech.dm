/datum/trade_station/bluespace_technical
	...
	offer_types = list(
		...
		/obj/item/weapon/oddity/si_bluespace_scanner = offer_data("Bluespace Tuning Device", 2200, 3),	// Significantly higher material cost per piece, longer production time per piece, more diverse mat req hence increase in sale price
