/datum/trade_station/mat_refinery
	...
	offer_types = list(
		...
		/obj/item/stack/ore/iron = offer_data("full stack of hematite", 700, 2),
		/obj/item/stack/ore/coal = offer_data("full stack of raw carbon", 700, 2),
		/obj/item/stack/ore/glass = offer_data("full stack of sand", 600, 4),
		/obj/item/stack/ore/silver = offer_data("full stack of native silver ore", 1500, 1),
		/obj/item/stack/ore/gold = offer_data("full stack of native gold ore", 3000, 1),
		/obj/item/stack/ore/diamond = offer_data("full stack of diamonds", 8000, 1),
		/obj/item/stack/ore/osmium = offer_data("full stack of raw platinum", 7000, 1),
		/obj/item/stack/ore/hydrogen = offer_data("full stack of raw hydrogen", 6000, 1),
		/obj/item/stack/ore/uranium = offer_data("full stack of pitchblende", 3250, 1),
		/obj/item/stack/ore/plasma = offer_data("full stack of plasma crystals", 3000, 1)
	)
