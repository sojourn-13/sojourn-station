...
/mob/living/carbon/human/nanogate/proc/nanite_regen()
	...
	if(!stats.getPerk(PERK_NANITE_REGEN)) // Do they already have the bot?
		if(thrdprn.pay_power_cost(nano_point_cost))
			...
			verbs -= /mob/living/carbon/human/nanogate/proc/nanite_regen
			thrdprn.nanogate_verbs -= /mob/living/carbon/human/nanogate/proc/nanite_regen
...
/mob/living/carbon/human/nanogate/proc/nanite_muscle()
	...
	var/nano_point_cost = 5 // Install two augments on both legs
	var/obj/item/organ/internal/nanogate/thrdprn = random_organ_by_process(BP_NANOGATE)
	...
	if(!stats.getPerk(PERK_NANITE_MUSCLE)) // Do they already have the perk?
		if(thrdprn.pay_power_cost(nano_point_cost))
			...
			verbs -= /mob/living/carbon/human/nanogate/proc/nanite_muscle
			thrdprn.nanogate_verbs -= /mob/living/carbon/human/nanogate/proc/nanite_muscle
...
/mob/living/carbon/human/nanogate/proc/nanite_armor()
	...
	if(!stats.getPerk(PERK_NANITE_ARMOR)) // Do they already have the perk?
		if(thrdprn.pay_power_cost(nano_point_cost))
			...
			verbs -= /mob/living/carbon/human/nanogate/proc/nanite_armor
			thrdprn.nanogate_verbs -= /mob/living/carbon/human/nanogate/proc/nanite_armor
...
/mob/living/carbon/human/nanogate/proc/nanite_chem()
	...
	if(species.reagent_tag == IS_SYNTHETIC)
		...
		verbs -= /mob/living/carbon/human/nanogate/proc/nanite_chem
		thrdprn.nanogate_verbs -= /mob/living/carbon/human/nanogate/proc/nanite_chem
		return
	...
	if(choice && thrdprn.pay_power_cost(nano_point_cost)) // Check if the user actually made a choice, and if they did, check if they have the points.
...
/mob/living/carbon/human/nanogate/proc/nanite_mod()
	...
	if(choice && thrdprn.pay_power_cost(nano_point_cost))
...
/mob/living/carbon/human/nanogate/proc/nanite_ammo()
	...
	if(!stats.getPerk(PERK_NANITE_AMMO)) // Do they already have the perk?
		if(thrdprn.pay_power_cost(nano_point_cost))
			...
			verbs -= /mob/living/carbon/human/nanogate/proc/nanite_ammo
			thrdprn.nanogate_verbs -= /mob/living/carbon/human/nanogate/proc/nanite_ammo
...
/mob/living/carbon/human/nanogate/proc/nanite_stats()
	...
	if(stat && thrdprn.pay_power_cost(nano_point_cost))
...
/mob/living/carbon/human/nanogate/proc/nanite_food_storage()
	...
	if(species.reagent_tag == IS_SYNTHETIC)
		to_chat(src, "a small beep of your nanogate tells you \"ERROR, REFUNDING NANITES: ASSIGNMENT IMPOSSIBLE FOR SYNTHETICS!\"")
		verbs -= /mob/living/carbon/human/nanogate/proc/nanite_food_storage
		thrdprn.nanogate_verbs -= /mob/living/carbon/human/nanogate/proc/nanite_food_storage
		return
...
/mob/living/carbon/human/nanogate/proc/nanite_metal_drinker()
	...
	if(species.reagent_tag == IS_SYNTHETIC)
		to_chat(src, "a small beep of your nanogate tells you \"ERROR, REFUNDING NANITES: ASSIGNMENT IMPOSSIBLE FOR SYNTHETICS!\"")
		verbs -= /mob/living/carbon/human/nanogate/proc/nanite_metal_drinker
		thrdprn.nanogate_verbs -= /mob/living/carbon/human/nanogate/proc/nanite_metal_drinker
		return
