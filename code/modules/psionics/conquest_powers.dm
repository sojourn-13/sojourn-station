...
/obj/item/organ/internal/psionic_tumor/conquest/proc/nightmare_mind()
	...
	psi_point_cost = 1
	catalyst_name = "Nightmarish Thoughts"
	catalyst_desc = "Within this catalyst is the collected psyche of... other things, a certain restructuring of your thoughts may yet let you find allies elsewhere, in darker places."
...
/obj/item/organ/internal/psionic_tumor/conquest/proc/bring_darkness()
	set category = "Psionic powers"
	...
	psi_point_cost = 3
	catalyst_name = "Bring Darkness"
	catalyst_desc = "Some things are better left hidden from the warmth of the light."
...
/obj/item/organ/internal/psionic_tumor/conquest/proc/rust()
	set category = "Psionic powers"
	set name = "Rust (1)"
	set desc = "Expend a single psi point to wither an object, making it rust away and weaken."
	psi_point_cost = 1
	catalyst_name = "Rust"
	catalyst_desc = "It is better this way."
...
/obj/item/organ/internal/psionic_tumor/conquest/proc/decay()
	set category = "Psionic powers"
	set name = "Decay (2)"
	...
	psi_point_cost = 2
	catalyst_name = "Decay"
	catalyst_desc = "The best way to make friends."
...
/obj/item/organ/internal/psionic_tumor/conquest/proc/seek_the_dream()
	set category = "Psionic powers"
	...
	psi_point_cost = 5
	catalyst_name = "Dream Seeker"
	catalyst_desc = "A curious person may not like what must be sacrificed pursuing the truth. Perhaps it will find them first?"
...
/obj/item/organ/internal/psionic_tumor/conquest/proc/kings_decorum()
	set category = "Psionic powers"
	...
	psi_point_cost = 2
	catalyst_name = "Kings Decorum"
	catalyst_desc = "What a wonderful world."
...
/obj/item/organ/internal/psionic_tumor/conquest/proc/merge_flesh_and_steel()
	set category = "Psionic powers"
	...
	psi_point_cost = 10
	catalyst_name = "Heresy"
	catalyst_desc = "To grasp at perfection, to reach farther than one ever could, to be Icarus and soar beneath the sun. Shall you fall?"
...
/obj/item/organ/internal/psionic_tumor/conquest/proc/ascend_another()
	set category = "Psionic powers"
	...
	psi_point_cost = 5
	catalyst_name = "Ascension"
	catalyst_desc = "The creation of more of our kind is sacrosanct, to allow more to see beyond the veil of reality is to bring more minds, more eyes, to what we wish to show them."
...
/obj/item/organ/internal/psionic_tumor/conquest_boss/proc/cerebral_hemorrhage()
	set category = "Psionic powers"
	...
	psi_point_cost = 5
	catalyst_name = "Cerebral Hemorrhage"
	catalyst_desc = "A sturdy mind is destroyed by revelation, a weak mind is eviscerated."
...
/obj/item/organ/internal/psionic_tumor/conquest_boss/proc/mind_jack()
	set category = "Psionic powers"
	set name = "Mindjack (3)"
