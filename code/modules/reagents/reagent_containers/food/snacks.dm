...
/obj/item/weapon/reagent_containers/food/snacks/chickensteak
	name = "chicken steak"
...
/obj/item/weapon/reagent_containers/food/snacks/roastchicken
	name = "chicken roast"
...
/obj/item/weapon/reagent_containers/food/snacks/friedchikin
	name = "fried poultry"
...
/obj/item/weapon/reagent_containers/food/snacks/baconeggs
	name = "eggs and bacon"
...
/obj/item/weapon/reagent_containers/food/snacks/cube/roach
	name = "Roach Cube"
	desc = "Just add Blood!"
	reagent_flags = REFILLABLE
...
/obj/item/weapon/reagent_containers/food/snacks/cube/roach/proc/Expand()
	src.visible_message(SPAN_NOTICE("\The [src] expands!"))
	var/turf/T = get_turf(src)
...
/obj/item/weapon/reagent_containers/food/snacks/cube/roach/on_reagent_change()
	if(reagents.has_reagent("blood"))
		Expand()

/obj/item/weapon/reagent_containers/food/snacks/cube/fuhrer
	name = "Fuhrer Cube"
	desc = "Just add Blood!"
	reagent_flags = REFILLABLE
	icon = 'icons/obj/roach_cubes.dmi'
...
/obj/item/weapon/reagent_containers/food/snacks/cube/fuhrer/proc/Expand()
	src.visible_message(SPAN_NOTICE("\The [src] expands!"))
	var/turf/T = get_turf(src)
...
/obj/item/weapon/reagent_containers/food/snacks/cube/fuhrer/on_reagent_change()
	if(reagents.has_reagent("blood"))
		Expand()

/obj/item/weapon/reagent_containers/food/snacks/cube/jager
	name = "Jager Cube"
	desc = "Just add Blood!"
	reagent_flags = REFILLABLE
	icon = 'icons/obj/roach_cubes.dmi'
...
/obj/item/weapon/reagent_containers/food/snacks/cube/jager/proc/Expand()
	src.visible_message(SPAN_NOTICE("\The [src] expands!"))
	var/turf/T = get_turf(src)
...
/obj/item/weapon/reagent_containers/food/snacks/cube/jager/on_reagent_change()
	if(reagents.has_reagent("blood"))
		Expand()

/obj/item/weapon/reagent_containers/food/snacks/cube/kraftwerk
	name = "Kraftwerk Cube"
	desc = "Just add Blood!"
	reagent_flags = REFILLABLE
	icon = 'icons/obj/roach_cubes.dmi'
...
/obj/item/weapon/reagent_containers/food/snacks/cube/kraftwerk/proc/Expand()
	src.visible_message(SPAN_NOTICE("\The [src] expands!"))
	var/turf/T = get_turf(src)
...
/obj/item/weapon/reagent_containers/food/snacks/cube/kraftwerk/on_reagent_change()
	if(reagents.has_reagent("blood"))
		Expand()

/obj/item/weapon/reagent_containers/food/snacks/cube/roachling
	name = "Roachling Cube"
	desc = "Just add Blood!"
	reagent_flags = REFILLABLE
	icon = 'icons/obj/roach_cubes.dmi'
...
/obj/item/weapon/reagent_containers/food/snacks/cube/roachling/proc/Expand()
	src.visible_message(SPAN_NOTICE("\The [src] expands!"))
	var/turf/T = get_turf(src)
...
/obj/item/weapon/reagent_containers/food/snacks/cube/roachling/on_reagent_change()
	if(reagents.has_reagent("blood"))
		Expand()

/obj/item/weapon/reagent_containers/food/snacks/cube/seuche
	name = "Seuche Cube"
	desc = "Just add Blood!"
	reagent_flags = REFILLABLE
	icon = 'icons/obj/roach_cubes.dmi'
...
/obj/item/weapon/reagent_containers/food/snacks/cube/seuche/proc/Expand()
	src.visible_message(SPAN_NOTICE("\The [src] expands!"))
	var/turf/T = get_turf(src)
...
/obj/item/weapon/reagent_containers/food/snacks/cube/seuche/on_reagent_change()
	if(reagents.has_reagent("blood"))
		Expand()

/obj/item/weapon/reagent_containers/food/snacks/cube/panzer
	name = "Panzer Cube"
	desc = "Just add Blood!"
	reagent_flags = REFILLABLE
	icon = 'icons/obj/roach_cubes.dmi'
...
/obj/item/weapon/reagent_containers/food/snacks/cube/panzer/proc/Expand()
	src.visible_message(SPAN_NOTICE("\The [src] expands!"))
	var/turf/T = get_turf(src)
...
/obj/item/weapon/reagent_containers/food/snacks/cube/grestrahlte/proc/Expand()
	src.visible_message(SPAN_NOTICE("\The [src] expands!"))
	var/turf/T = get_turf(src)
...
/obj/item/weapon/reagent_containers/food/snacks/cube/grestrahlte/on_reagent_change()
	if(reagents.has_reagent("blood"))
		Expand()
...
/obj/item/weapon/reagent_containers/food/snacks/katsudon
	name = "katsudon"
...
/obj/item/weapon/reagent_containers/food/snacks/mre/can/open(mob/user)
	desc = "An opened can of stewed meat, ready for consumption."
	icon_state = "ration_can_open"
	open = TRUE
	reagent_flags |= REFILLABLE

/obj/item/weapon/reagent_containers/food/snacks/mre/can/heat()
	for(var/reagent in heated_reagents)
		reagents.add_reagent(reagent, heated_reagents[reagent])
	bitesize = 6
...
/obj/item/weapon/reagent_containers/food/snacks/breadslice/attackby(obj/item/weapon/W as obj, mob/user as mob)
	if(istype(W,/obj/item/weapon/reagent_containers/food/snacks/butterslice))
		new /obj/item/weapon/reagent_containers/food/snacks/butterbread(src)
		to_chat(user, "You spread the butter slice on the toast.")
		qdel(W)
		qdel(src)

/obj/item/weapon/reagent_containers/food/snacks/butterbread
	name = "buttered toast"
...
/obj/item/weapon/reagent_containers/food/snacks/sliceable/butterstick
	name = "stick of butter"
	desc = "A whole stick of salted butter, an excellent flavor booster or spread."
	icon_state = "butter"
	slice_path = /obj/item/weapon/reagent_containers/food/snacks/butterslice
	slices_num = 5
	nutriment_amt = 10
	matter = list(MATERIAL_BIOMATTER = 10)

/obj/item/weapon/reagent_containers/food/snacks/butterslice // I'm so sorry for this. Wasting an entire stick of butter on a toast is a no.
	name = "slice of butter"
	desc = "A slice of salted butter ready to be spread over toast or used on recipes."
...
/obj/item/weapon/reagent_containers/food/snacks/rawcutlet/attackby(obj/item/weapon/W as obj, mob/user as mob)
	if(istype(W,/obj/item/weapon/material/kitchen/rollingpin))
		new /obj/item/weapon/reagent_containers/food/snacks/patty_raw(src)
		to_chat(user, "You pound the meat into a patty.") // You can finally pound your meat.
		qdel(src)

/obj/item/weapon/reagent_containers/food/snacks/patty_raw
	name = "raw patty"
...
/obj/item/weapon/reagent_containers/food/snacks/chickenbreast
	name = "poultry breast"
