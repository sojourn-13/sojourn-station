...
/datum/reagent/stim/xenotoxin/affect_blood(var/mob/living/carbon/M, var/alien, var/effect_multiplier)
...
/datum/reagent/stim/xenotoxin/withdrawal_act(mob/living/carbon/M)
...
/datum/reagent/stim/xenotoxin/overdose(var/mob/living/carbon/M, var/alien)
	M.adjustBrainLoss(2)
	M.slurring = max(M.slurring, 30)
	if(prob(5))
		M.vomit()