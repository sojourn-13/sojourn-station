/obj/machinery/sleeper/sarcophagus
	...
	circuit = /obj/item/circuitboard/sarcophagus
...
/obj/item/circuitboard/sarcophagus
	name = "circuit board (medi-sarcophagus)"
...
/obj/item/circuitboard/sarcophagus/Initialize()
	. = ..()
	...
	if(prob(25))
		available_chemicals |= pick(list(list("bicaridine" = "Bicaridine"), list("oil" = "Bicaridone"), list("toxin" = "Bicarizine")))
	if(prob(25))
		available_chemicals |= pick(list(list("dermaline" = "Dermaline"), list("oil" = "Dermazine"), list("toxin" = "Dermalyne")))
	if(prob(25))
		available_chemicals |= pick(list(list("tramadol" = "Tramadol"), list("oil" = "Tramadone"), list("toxin" = "Tramamol")))
	if(prob(25))
		available_chemicals |= pick(list(list("hyronalin" = "Hyronalin"), list("oil" = "Hyronaline"), list("toxin" = "Hyronalyne")))

	if(prob(5))
		available_chemicals |= pick(list(list("oxycodone" = "Oxycodone"), list("oil" = "Oxycodol"), list("toxin" = "Oxycodine")))
	if(prob(5))
		available_chemicals |= pick(list(list("meralyne" = "Meralyne"), list("oil" = "Meraline"), list("toxin" = "Meradine")))
