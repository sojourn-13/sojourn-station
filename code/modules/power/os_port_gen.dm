/obj/machinery/power/port_gen/os_generator
	...
	desc = "A Greyson Positronic portable fusion microgenerator rather complicated and hard to use on top of needing a certification to operate one quickly led to only inhouse use rather then market success."
