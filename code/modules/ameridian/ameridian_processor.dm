...
/obj/machinery/ameridian_processor
	...
	*/
	var/list/recipes = list(
		"Steel",
			list(name="Steel (1)", cost=1000, path=/obj/item/stack/material/steel),
			list(name="Steel (120)", cost=12000, path=/obj/item/stack/material/steel/full),
		"Plastic",
			list(name="Plastic (1)", cost=1000, path=/obj/item/stack/material/plastic),
			list(name="Plastic (120)", cost=12000, path=/obj/item/stack/material/plastic/full),
		"Glass",
			list(name="Glass (1)", cost=1000, path=/obj/item/stack/material/glass),
			list(name="Glass (120)", cost=12000, path=/obj/item/stack/material/glass/full),
		"Plasteel",
			list(name="Plasteel (1)", cost=3500, path=/obj/item/stack/material/plasteel),
			list(name="Plasteel (120)", cost=420000, path=/obj/item/stack/material/plasteel/full),
		"Silver",
			list(name="Silver (1)", cost=2000, path=/obj/item/stack/material/silver),
			list(name="Silver (120)", cost=240000, path=/obj/item/stack/material/silver/full),
		"Gold",
			list(name="Gold (1)", cost=2000, path=/obj/item/stack/material/gold),
			list(name="Gold (120)", cost=240000, path=/obj/item/stack/material/gold/full),
		"Platinum",
			list(name="Platinum (1)", cost=2500, path=/obj/item/stack/material/platinum),
			list(name="Platinum (120)", cost=300000, path=/obj/item/stack/material/platinum/full),
		"Uranium",
			list(name="Uranium (1)", cost=2500, path=/obj/item/stack/material/uranium),
			list(name="Uranium (120)", cost=300000, path=/obj/item/stack/material/uranium/full),
		"Plasma",
			list(name="Plasma (1)", cost=2500, path=/obj/item/stack/material/plasma),
			list(name="Plasma (120)", cost=300000, path=/obj/item/stack/material/plasma/full),
		"Osmium",
			list(name="Osmium (1)", cost=4000, path=/obj/item/stack/material/osmium),
			list(name="Osmium (120)", cost=480000, path=/obj/item/stack/material/osmium/full),
		"Diamonds",
			list(name="Diamonds (1)", cost=4000, path=/obj/item/stack/material/diamond),
			list(name="Diamonds (120)", cost=480000, path=/obj/item/stack/material/diamond/full),
		"Metallic Hydrogen",
			list(name="Metallic Hydrogen (1)", cost=4000, path=/obj/item/stack/material/mhydrogen),
			list(name="Metallic Hydrogen (120)", cost=480000, path=/obj/item/stack/material/mhydrogen/full),
		"Tritium",
			list(name="Tritium (1)", cost=4000, path=/obj/item/stack/material/tritium),
			list(name="Tritium (120)", cost=480000, path=/obj/item/stack/material/tritium/full),
	)
