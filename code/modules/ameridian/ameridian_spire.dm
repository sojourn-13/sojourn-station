...
/obj/structure/ameridian_crystal/spire/add_initial_transforms()
	add_transformation_type(list(/datum/transform_type/modular, scalex = 1.5, scaley = 1.5, flagarg = AMERIDIAN_SPIRE_INITIAL_SCALE_TRANSFORM, priorityarg = AMERIDIAN_SPIRE_INITIAL_SCALE_TRANSFORM_PRIORITY))
	. = ..()
