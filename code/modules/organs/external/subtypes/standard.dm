...
/obj/item/organ/external/head/take_damage(amount, damage_type, armor_penetration = max(0.001, armor_penetration), wounding_multiplier = 1, sharp, edge, used_weapon = null, list/forbidden_limbs = list(), silent)
	. = ..()
	if(. && !disfigured)
		if(amount > 25)
