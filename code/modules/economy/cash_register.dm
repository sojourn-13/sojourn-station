...
/obj/machinery/cash_register/proc/get_current_transaction()
	...
	for(var/i=1, i<=item_list.len, i++)
		...
		dat += "<tr><td class=\"tx-name-r\">[item_list[item_name] ? "<a href='byond://?src=\ref[src];choice=subtract;item=\ref[item_name]'>-</a> <a href='byond://?src=\ref[src];choice=set_amount;item=\ref[item_name]'>Set</a> <a href='byond://?src=\ref[src];choice=add;item=\ref[item_name]'>+</a> [item_list[item_name]] x " : ""][item_name] ([price_list[item_name]] &thorn <a href='byond://?src=\ref[src];choice=set_price;item=\ref[item_name]'>Change</a>) <a href='byond://?src=\ref[src];choice=clear;item=\ref[item_name]'>Remove</a></td><td class=\"tx-data-r\" width=50>[price_list[item_name] * item_list[item_name]] &thorn</td></tr>"
