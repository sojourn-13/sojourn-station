...
/*	if(!T) //Gender has been expanded, this check is no longer necessary.
	...
	if(w_uniform && !skipjumpsuit)
		...
		if(w_uniform.blood_DNA)
			msg += "<span class='warning'>[He] [is] wearing \icon[w_uniform] [w_uniform.gender==PLURAL?"some":"a"] [(w_uniform.blood_color != "#030303") ? "blood" : "oil"]-stained <a href='?src=\ref[src];lookitem=\ref[w_uniform]'>\a [w_uniform]</a>[tie_msg]!</span>\n"
		else
			msg += "[He] [is] wearing \icon[w_uniform] <a href='?src=\ref[src];lookitem=\ref[w_uniform]'>\a [w_uniform]</a>[tie_msg].\n"

	//head
	if(head)
		if(head.blood_DNA)
			msg += "<span class='warning'>[He] [is] wearing \icon[head] [head.gender==PLURAL?"some":"a"] [(head.blood_color != "#030303") ? "blood" : "oil"]-stained <a href='?src=\ref[src];lookitem=\ref[head]'>\a [head]</a> on [his] head!</span>\n"
		else
			msg += "[He] [is] wearing \icon[head] <a href='?src=\ref[src];lookitem=\ref[head]'>\a [head]</a> on [his] head.\n"

	//suit/armour
	if(wear_suit)
		if(wear_suit.blood_DNA)
			msg += "<span class='warning'>[He] [is] wearing \icon[wear_suit] [wear_suit.gender==PLURAL?"some":"a"] [(wear_suit.blood_color != "#030303") ? "blood" : "oil"]-stained <a href='?src=\ref[src];lookitem=\ref[wear_suit]'>\a [wear_suit]</a>!</span>\n"
		else
			msg += "[He] [is] wearing \icon[wear_suit] <a href='?src=\ref[src];lookitem=\ref[wear_suit]'>\a [wear_suit]</a>.\n"

		//suit/armour storage
		if(s_store && !skipsuitstorage)
			if(s_store.blood_DNA)
				msg += "<span class='warning'>[He] [is] carrying \icon[s_store] [s_store.gender==PLURAL?"some":"a"] [(s_store.blood_color != "#030303") ? "blood" : "oil"]-stained <a href='?src=\ref[src];lookitem=\ref[s_store]'>\a [s_store]</a> on [his] [wear_suit]!</span>\n"
			else
				msg += "[He] [is] carrying \icon[s_store] <a href='?src=\ref[src];lookitem=\ref[s_store]'>\a [s_store]</a> on [his] [wear_suit].\n"

	//back
	if(back)
		if(back.blood_DNA)
			msg += "<span class='warning'>[He] [has] \icon[back] [back.gender==PLURAL?"some":"a"] [(back.blood_color != "#030303") ? "blood" : "oil"]-stained <a href='?src=\ref[src];lookitem=\ref[back]'>\a [back]</a> on [his] back.</span>\n"
		else
			msg += "[He] [has] \icon[back] <a href='?src=\ref[src];lookitem=\ref[back]'>\a [back]</a> on [his] back.\n"

	//left hand
	if(l_hand&& !(l_hand.item_flags & ABSTRACT))//Abstract items don't show up when examined.
		if(l_hand.blood_DNA)
			msg += "<span class='warning'>[He] [is] holding \icon[l_hand] [l_hand.gender==PLURAL?"some":"a"] [(l_hand.blood_color != "#030303") ? "blood" : "oil"]-stained <a href='?src=\ref[src];lookitem=\ref[l_hand]'>\a [l_hand]</a> [l_hand.wielded ? "hands" : "left hand"]!</span>\n"
		else
			msg += "[He] [is] holding \icon[l_hand] <a href='?src=\ref[src];lookitem=\ref[l_hand]'>\a [l_hand]</a> in [his] [l_hand.wielded ? "hands" : "left hand"].\n"

	//right hand
	if(r_hand && !(r_hand.item_flags & ABSTRACT))
		if(r_hand.blood_DNA)
			msg += "<span class='warning'>[He] [is] holding \icon[r_hand] [r_hand.gender==PLURAL?"some":"a"] [(r_hand.blood_color != "#030303") ? "blood" : "oil"]-stained <a href='?src=\ref[src];lookitem=\ref[r_hand]'>\a [r_hand]</a> in [his] [r_hand.wielded ? "hands" : "right hand"]!</span>\n"
		else
			msg += "[He] [is] holding \icon[r_hand] <a href='?src=\ref[src];lookitem=\ref[r_hand]'>\a [r_hand]</a> in [his] [r_hand.wielded ? "hands" : "right hand"].\n"

	//gloves
	if(gloves && !skipgloves)
		if(gloves.blood_DNA)
			msg += "<span class='warning'>[He] [has] \icon[gloves] [gloves.gender==PLURAL?"some":"a"] [(gloves.blood_color != "#030303") ? "blood" : "oil"]-stained <a href='?src=\ref[src];lookitem=\ref[gloves]'>\a [gloves]</a> on [his] hands!</span>\n"
		else
			msg += "[He] [has] \icon[gloves] <a href='?src=\ref[src];lookitem=\ref[gloves]'>\a [gloves]</a> on [his] hands.\n"
	else if(blood_DNA)
	...
	if(belt)
		if(belt.blood_DNA)
			msg += "<span class='warning'>[He] [has] \icon[belt] [belt.gender==PLURAL?"some":"a"] [(belt.blood_color != "#030303") ? "blood" : "oil"]-stained <a href='?src=\ref[src];lookitem=\ref[belt]'>\a [belt]</a> about [his] waist!</span>\n"
		else
			msg += "[He] [has] \icon[belt] <a href='?src=\ref[src];lookitem=\ref[belt]'>\a [belt]</a> about [his] waist.\n"

	//shoes
	if(shoes && !skipshoes)
		if(shoes.blood_DNA)
			msg += "<span class='warning'>[He] [is] wearing \icon[shoes] [shoes.gender==PLURAL?"some":"a"] [(shoes.blood_color != "#030303") ? "blood" : "oil"]-stained <a href='?src=\ref[src];lookitem=\ref[shoes]'>\a [shoes]</a> on [his] feet!</span>\n"
		else
			msg += "[He] [is] wearing \icon[shoes] <a href='?src=\ref[src];lookitem=\ref[shoes]'>\a [shoes]</a> on [his] feet.\n"
	...
	if(wear_mask && !skipmask)
		...
		if(wear_mask.blood_DNA)
			msg += "<span class='warning'>[He] [has] \icon[wear_mask] [wear_mask.gender==PLURAL?"some":"a"] [(wear_mask.blood_color != "#030303") ? "blood" : "oil"]-stained <a href='?src=\ref[src];lookitem=\ref[wear_mask]'>\a [wear_mask]</a> [descriptor]!</span>\n"
		else
			msg += "[He] [has] \icon[wear_mask] <a href='?src=\ref[src];lookitem=\ref[wear_mask]'>\a [wear_mask]</a> [descriptor].\n"

	//eyes
	if(glasses && !skipeyes)
		if(glasses.blood_DNA)
			msg += "<span class='warning'>[He] [has] \icon[glasses] [glasses.gender==PLURAL?"some":"a"] [(glasses.blood_color != "#030303") ? "blood" : "oil"]-stained <a href='?src=\ref[src];lookitem=\ref[glasses]'>\a [glasses]</a> covering [his] eyes!</span>\n"
		else
			msg += "[He] [has] \icon[glasses] <a href='?src=\ref[src];lookitem=\ref[glasses]'>\a [glasses]</a> covering [his] eyes.\n"

	//left ear
	if(l_ear && !skipears)
		msg += "[He] [has] \icon[l_ear] <a href='?src=\ref[src];lookitem=\ref[l_ear]'>\a [l_ear]</a> on [his] left ear.\n"

	//right ear
	if(r_ear && !skipears)
		msg += "[He] [has] \icon[r_ear] <a href='?src=\ref[src];lookitem=\ref[r_ear]'>\a [r_ear]</a> on [his] right ear.\n"

	//ID
	if(wear_id)
		msg += "[He] [is] wearing \icon[wear_id] <a href='?src=\ref[src];lookitem=\ref[wear_id]'>\a [wear_id]</a>.\n"
