...
/mob/living/carbon/superior/robot/gp/synth/epistol/sniper/lowrange //lower performance impact
	viewRange = 20
	comfy_range = 20

/mob/living/carbon/superior/robot/gp/synth/epistol/sniper/medrange //moderate performance impact
	viewRange = 40
	comfy_range = 40

/mob/living/carbon/superior/robot/gp/synth/epistol/sniper/highrange_laggy //for use in absurd distances, large performance impact comparatively
	viewRange = 100
	comfy_range = 100
