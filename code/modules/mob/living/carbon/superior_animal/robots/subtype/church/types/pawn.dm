/mob/living/carbon/superior_animal/robot/church/pawm
	name = "Pawn Golem"
	desc = "The Bishop, a golem made by the church and fashioned after the time honored game of chess by Brynn. Those who underestimate pawns always lose, being the weakest of church golems, \
