/mob/living/carbon/superior_animal/psi_monster/flesh_behemoth
	name = "flesh behemoth"
	desc = "Hunger, hunger for meat. Meat meat meat. It comes, impossibly strong and looking to devour everything in its path, a wicked blade of bone ready to slice you apart."
	icon_state = "vargo"
	icon_living = "vargo"
...
/mob/living/carbon/superior_animal/wasonce/crimson_jelly
	name = "crimson jelly"
...
/mob/living/carbon/superior_animal/wasonce/pitch_horror
	name = "pitch horror"
