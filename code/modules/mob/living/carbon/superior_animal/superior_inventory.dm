...
/mob/living/carbon/superior_animal/verb/quick_equip()
...
/mob/living/carbon/superior_animal/put_in_active_hand(var/obj/item/W)
...
/mob/living/carbon/superior_animal/put_in_inactive_hand(var/obj/item/W)
	return (hand ? put_in_r_hand(W) : put_in_l_hand(W))

/mob/living/carbon/superior_animal/put_in_hands(var/obj/item/W)
	if(!W)
		return FALSE
...
/mob/living/carbon/superior_animal/put_in_l_hand(var/obj/item/W)
	W.add_fingerprint(src)
	return equip_to_slot_if_possible(W, slot_l_hand)

/mob/living/carbon/superior_animal/put_in_r_hand(var/obj/item/W)
	W.add_fingerprint(src)
	return equip_to_slot_if_possible(W, slot_r_hand)


//Find HUD position on screen
/mob/living/carbon/superior_animal/proc/find_inv_position(var/slot_id)
...
/mob/living/carbon/superior_animal/dummy/mannequin/find_inv_position(var/slot_id)
	return "7,7"

/mob/living/carbon/superior_animal/proc/equip_in_one_of_slots(obj/item/W, list/slots, del_on_fail = 1)
...
/*
/mob/living/carbon/superior_animal/proc/has_organ(name, check_usablility = FALSE)
...
/*			if(internals)
	...
	return 1
/*					/// TODO: Give simple_mobs a way to handle items. ///
/mob/living/carbon/superior_animal/proc/get_active_hand_organ()
	if(hand)
		return get_organ(BP_L_ARM)
	else
		return get_organ(BP_R_ARM)
*/
/mob/living/carbon/superior_animal/proc/get_holding_hand(var/obj/item/W)
...
/mob/living/carbon/superior_animal/equip_to_slot(obj/item/W, slot, redraw_mob = 1)
...
/mob/living/carbon/superior_animal/proc/draw_from_suit_storage()
...
/mob/living/carbon/superior_animal/proc/legacy_equip_to_slot(obj/item/W, slot, redraw_mob = 1)
	switch(slot)
		if(slot_back)
			src.back = W
		if(slot_wear_mask)
...
/mob/living/carbon/superior_animal/slot_is_accessible(var/slot, var/obj/item/I, mob/user=null)
...
/mob/living/carbon/superior_animal/get_equipped_item(var/slot)
	switch(slot)
...
/mob/living/carbon/superior_animal/get_equipped_items(var/include_carried = 0)
...
/mob/living/carbon/superior_animal/get_max_w_class()
