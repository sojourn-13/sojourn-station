...
/mob/living/carbon/superior_animal/lodge/baby_tatonka/add_initial_transforms()
	...
	add_transformation_type(list(/datum/transform_type/modular, 0.5, 0.5, flagarg = BABY_TANTONKA_INITIAL_SCALE_TRANSFORM, priorityarg = BABY_TANTONKA_INITIAL_SCALE_TRANSFORM_PRIORITY))
