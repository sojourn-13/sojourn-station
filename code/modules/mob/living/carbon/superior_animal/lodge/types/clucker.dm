...
/mob/living/carbon/superior/lodge/clucker
	...
	speak_chance = 2
	turns_per_move = 3
	meat_type = /obj/item/reagent_containers/snacks/chickenbreast //So hunters can eat mor chikin
	meat_amount = 4
	health = 10
	var/eggsleft = 0
...
/mob/living/carbon/superior/lodge/clucker/Life()
	...
	if(!stat && prob(3) && eggsleft > 0)
		...
		eggsleft--
		var/obj/item/reagent_containers/snacks/egg/clucker/E = new(get_turf(src))
		E.pixel_x = rand(-6,6)
		E.pixel_y = rand(-6,6)
...
/obj/item/reagent_containers/snacks/egg/clucker/amount_grown = 0
/obj/item/reagent_containers/snacks/egg/clucker/Process()
	if(isturf(loc))
