...
/mob/living/carbon/standard_weapon_hit_effects(obj/item/I, mob/living/user, var/effective_force, var/hit_zone)
	...
	damage_through_armor(effective_force, I.damtype, hit_zone, ARMOR_MELEE, armor_divisor = I.armor_divisor + (user.stats.getStat(STAT_ROB) * 0.05), used_weapon = I, sharp = weapon_sharp, edge = weapon_edge)
