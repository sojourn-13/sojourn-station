...
const rank2icon = {
  ...
  'Vesalius-Andra Doctor': 'user-md',
  'Vesalius-Andra Medical Student': ['user-md', 'school'],
  'Vesalius-Andra Nurse': 'user-nurse',
  'Vesalius-Andra Emergency Physician': ['user-md', 'hospital'],
  'Vesalius-Andra Surgeon': 'user-md',
  'Vesalius-Andra Lifeline Technician': 'ambulance',
  'Vesalius-Andra Psychiatrist': ['user-md', 'brain'],
  'Vesalius-Andra Psychologist': ['user-md', 'brain'],
  'Vesalius-Andra Empath': ['user-md', 'brain'],
  // Offcolony
  ...
  'Vesalius-Andra Scientist': 'flask',
  'Vesalius-Andra Research Student': ['flask', 'school'],
  'Vesalius-Andra Xenobiologist': 'meteor',
  'Vesalius-Andra Xenoarcheologist': 'meteor',
  'Vesalius-Andra Xenobotanist': ['biohazard', 'seedling'],
  'Vesalius-Andra Research Fabricator': ['flask', 'hammer'],
  'Vesalius-Andra Geneticist': 'dna',
  'Vesalius-Andra Roboticist': 'robot',
  'Vesalius-Andra Roboticist Trainee': ['robot', 'school'],
  'Vesalius-Andra Cyberneticist': 'robot',
  'Vesalius-Andra Mechanist': 'robot',
  'Vesalius-Andra Biomechanical Engineer': 'robot',
  // Security
